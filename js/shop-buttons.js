...
function shopButtonsTest(p, lang) {
  ...
  const moreBtn =
    ...
    '<span style="display:flex;align-items:center;gap:10px">' + cartSvg + '<span>' + t('Comparar en 5 tiendas más', 'Compare 5 more stores') + '</span></span>' + '<span style=\'position:absolute;right:16px;top:50%;transform:translateY(-50%);flex-shrink:0;pointer-events:none\'>' + chevSvg + '</span>' + '</button>' +
