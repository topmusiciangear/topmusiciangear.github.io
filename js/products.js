const products = [
  // ===== MICROPHONES =====
  {
    ...
    desc_es: "El micr├│fono din├ímico est├índar de la industria para transmisi├│n, podcasting y grabaci├│n vocal. Sonido c├ílido y suave con excelente rechazo.",
  ...
  },
  {
    ...
    desc_es: "El micr├│fono de condensador de estudio m├ís famoso del mundo. Usado en innumerables ├®xitos discogr├íficos. Tres patrones polares, pad de 10dB y legendario sonido Neumann.",
  ...
  },
  {
    ...
    desc_es: "El micr├│fono de condensador de estudio m├ís silencioso del mundo. Calidad de audio impecable con un car├ícter c├ílido y suave. Incluye soporte antigolpes y filtro antipop.",
  ...
  },
  {
    ...
    desc_es: "Condensador vers├ítil de diafragma grande con 5 patrones polares. Desde voces hasta piano, el C414 lo maneja todo con un detalle impresionante.",
  ...
  },
  {
    ...
    desc_es: "El micr├│fono de instrumento m├ís grabado de la historia. Indestructible, asequible e incre├¡ble en gabinetes de guitarra, cajas y trompetas. Todo m├║sico deber├¡a tener uno.",
  ...
  },
  {
    ...
    desc_es: "El micr├│fono vocal m├ís popular del mundo. Usado por presidentes, estrellas pop y cantantes de bar por igual. Construido como un tanque con respuesta de frecuencia adaptada para voces que cortan cualquier mezcla.",
    img: "img/sm58.jpg",
    stores: {
  ...
  },
  {
    ...
    desc_es: "El rey de los toms y leyenda de gabinetes de guitarra. Interruptor de corte de graves de cinco posiciones, maneja SPLs de hasta 160dB. El din├ímico est├índar de la industria para instrumentos desde 1960.",
    img: "img/md421.jpg",
    stores: {
  ...
  },
  {
    ...
    desc_es: "El est├índar de transmisi├│n. La tecnolog├¡a Variable-D elimina el efecto de proximidad. La elecci├│n definitiva para podcasting, locuci├│n y bombos.",
    img: "img/re20.jpg",
    stores: {
  ...
  // ===== GUITARS =====
  {
    ...
    desc_es: "La ic├│nica Stratocaster, refinada. Pastillas V-Mod II, perfil de m├ístil Deep C y un elegante acabado satinado. Del blues al pop, es el sonido de la m├║sica moderna.",
  ...
  },
  {
    ...
    desc_es: "La m├íquina de rock definitiva. Pastillas Burstbucker, cuerpo de caoba con tapa de arce y ese inconfundible sustain Les Paul.",
  ...
  },
  {
    ...
    desc_es: "Una obra maestra de artesan├¡a ac├║stica. Tapa de abeto Sitka macizo, fondo y aros de palo negro de Tasmania, y la legendaria tocabilidad de Taylor.",
  ...
  },
  {
    ...
    desc_es: "La m├íquina de shred original. M├ístil Super Wizard, tr├®molo Edge y pastillas DiMarzio. Hecha para velocidad y precisi├│n.",
  ...
  },
  {
    ...
    desc_es: "El tributo de Paul Reed Smith a la era dorada de las guitarras el├®ctricas. Pastillas 58/15 LT, m├ístil pattern vintage y calidad de construcci├│n impecable.",
  ...
  // ===== KEYBOARDS =====
  {
    ...
    desc_es: "El piano de escenario definitivo. Teclado Triple Sensor, transiciones perfectas y los legendarios motores de piano, ├│rgano y sintetizador de Nord en un solo instrumento.",
  ...
  },
  {
    ...
    desc_es: "Sintetizador insignia con motores AN-X y FM-X. 88 teclas de acci├│n con peso, control de movimiento e integraci├│n perfecta con DAW.",
  ...
  },
  {
    ...
    desc_es: "El controlador DAW definitivo. Integraci├│n profunda con Analog Lab, Ableton Live y Logic. 61 teclas sensibles a la velocidad con aftertouch polif├│nico.",
  ...
  },
  {
    ...
    desc_es: "Controlador de teclado inteligente con integraci├│n al ecosistema NI. Gu├¡a de luz, navegaci├│n NKS y teclado Fatar premium.",
  ...
  // ===== INTERFACES =====
  {
    ...
    title_es: "Focusrite Scarlett 2i2 4├é┬¬ Gen",
    category: "interfaces",
    price: 199,
    rating: 4.7,
    reviews: 34567,
    ...
    desc_es: "La interfaz de audio m├ís vendida del mundo acaba de mejorar. 120dB de rango din├ímico, modo Air y Loopback para streaming. Conversi├│n de grado estudio.",
  ...
  },
  {
    ...
    desc_es: "El est├índar de oro para grabaci├│n port├ítil. Legendarios drivers RME, supresi├│n de jitter SteadyClock FS y conversi├│n AD/DA impecable.",
  ...
  },
  {
    ...
    desc_es: "Solid State Logic en una interfaz. Legendarios preamplificadores SSL 4K, channel strip anal├│gico Legacy 4K y funciones profesionales de monitoreo. MKII actualizado con convertidores 32-bit/192kHz.",
  ...
  },
  {
    ...
    desc_es: "Preamplificadores de grado consola en una interfaz compacta. Los mismos previos de micr├│fono Clase A que se encuentran en la consola ASP8024 de $50,000 de Audient. Salidas de auriculares duales y entrada DI JFET para instrumentos.",
  ...
  },
  {
    ...
    desc_es: "El mejor valor en su clase. Medici├│n LCD a todo color, DAC ESS Sabre32 Ultra y loopback para streaming. La ├║nica interfaz por menos de $200 con monitoreo de nivel en tiempo real.",
    img: "img/motu-m2.jpg",
    stores: {
  ...
  },
  {
    ...
    desc_es: "Calidad UA a precio de entrada. El modo Vintage Mic Preamp emula el cl├ísico previo de tubo UA 610. MIDI I/O y construcci├│n s├│lida con dise├▒o retro que destaca.",
  ...
  // ===== MONITORS =====
  {
    ...
    desc_es: "El est├índar de la industria para mezcla. Woofer de cono de 8 pulgadas con revestimiento de Kevlar, tweeter de domo de 1 pulgada y control de sala para monitoreo preciso.",
  ...
  },
  {
    ...
    desc_es: "Monitores de estudio bi-amplificados profesionales con drivers de Kevlar, ecualizador DSP y puerto de graves frontal. G5 con procesamiento 32-bit y correcci├│n de sala mejorada.",
  ...
  },
  {
    ...
    desc_es: "Monitor de 2 v├¡as de vanguardia con tweeter de cinta plegada S-ART. Respuesta transitoria inigualable, graves profundos e imagen 3D.",
  ...
  },
  {
    ...
    desc_es: "Precisi├│n finlandesa en su m├íxima expresi├│n. Woofer de 6.5 pulgadas, tweeter de domo met├ílico y la reconocida gu├¡a de onda Directivity Control de Genelec.",
  ...
  // ===== HEADPHONES =====
  {
    ...
    desc_es: "El est├índar de estudio para monitoreo cerrado. Drivers de 250 Ohm, almohadillas de velour y comodidad excepcional para sesiones maratonianas.",
  ...
  },
  {
    ...
    desc_es: "Auriculares de referencia abiertos audi├│filos. Sonido natural y neutro con detalle incre├¡ble. La elecci├│n del ingeniero de mezcla para escucha cr├¡tica.",
  ...
  },
  {
    ...
    desc_es: "Los auriculares de estudio m├ís populares del mundo. Claridad aclamada por la cr├¡tica, graves profundos y dise├▒o plegable para portabilidad.",
  ...
  },
  {
    ...
    desc_es: "El est├índar de transmisi├│n desde 1991. Cerrados, plegables e incre├¡blemente confiables. Usados por profesionales en todo el mundo.",
  ...
  },
  {
    ...
    desc_es: "Auriculares de mezcla abiertos con legendaria extensi├│n de graves. El escenario sonoro espacioso revela colas de reverb y colocaci├│n est├®reo con precisi├│n quir├║rgica. El hermano abierto del DT 770.",
  ...
  },
  {
    ...
    desc_es: "Sintonizado al objetivo Harman para el sonido cerrado m├ís natural por menos de $200. Dise├▒o plegable, cables desmontables y la respuesta de frecuencia m├ís plana en su clase.",
  ...
  // ===== PLUGINS =====
  {
    ...
    desc_es: "La plataforma de sampler l├¡der mundial. Kontakt 8 con nuevo navegador, m├│dulo wavetable, herramientas MIDI y m├ís de 900 instrumentos. El est├índar de la industria para instrumentos sampleados.",
  ...
  },
  {
    ...
    desc_es: "El kit definitivo de mezcla y masterizaci├│n. Pro-Q 4, Pro-C 3, Pro-L 2, Pro-R 2, Saturn 2, Timeless 3, Volcano 3, Twin 3 y m├ís.",
  ...
  },
  {
    ...
    desc_es: "Suite de masterizaci├│n de nueva generaci├│n impulsada por IA. 20 m├│dulos profesionales incluyendo Stem EQ, Clarity, Stabilizer y separaci├│n de stems mejorada con redes neuronales.",
    img: "img/ozone12.jpg",
    stores: {
  ...
  },
  {
    ...
    desc_es: "23 efectos ic├│nicos incluyendo Decapitator, EchoBoy, Little AlterBoy, SuperPlate, SpaceBlender y Effect Rack. La caja de herramientas del productor creativo.",
  ...
  // ===== PERCUSSION =====
  {
    ...
    desc_es: "La m├íquina de ritmo definitiva. Sonidos aut├®nticos de 808, 909 y 707 combinados con importaci├│n de samples y secuenciaci├│n avanzada.",
  ...
  },
  {
    ...
    desc_es: "Potencia de creaci├│n de beats con Wi-Fi y Bluetooth. Pantalla t├íctil de 7 pulgadas, 16 pads sensibles a la velocidad y el legendario flujo de trabajo MPC.",
  ...
  },
  {
    ...
    desc_es: "Platillos turcos martillados a mano con tonos c├ílidos y complejos. Incluye hi-hats de 14 pulgadas, crashes de 16 + 18 pulgadas y ride de 20 pulgadas.",
  ...
  },
  {
    ...
    desc_es: "Bater├¡a de grado profesional con cascos de nogal/abedul. Profundidad, ataque y resonancia incre├¡bles. Perfecta para estudio y escenario.",
  ...
  // ===== ACCESSORIES =====
  {
    ...
    desc_es: "El est├índar de la industria para cableado de estudio. Conductores Neglex OFC, conectores REAN y la legendaria fiabilidad Mogami.",
  ...
  },
  {
    ...
    desc_es: "Filtro antipop profesional de malla met├ílica. Pantalla de doble capa elimina oclusivas sin p├®rdida de altas frecuencias. Soporte de cuello de ganso ajustable.",
  ...
  },
  {
    ...
    desc_es: "Estuche moldeado aprobado ATA con interior de espuma EPS. Herrajes de alta resistencia, pestillos empotrados y ruedas para f├ícil transporte.",
  ...
  },
  {
    ...
    desc_es: "Controlador de faders motorizados de 8 canales con el legendario flujo de trabajo de consola SSL. Faders sensibles al tacto, protocolo MCU/HUI y construcci├│n premium.",
  ...
  },
  {
    ...
    desc_es: "Tres Cubano de grado profesional con tapa s├│lida de abeto para claridad, sustain y definici├│n excepcionales. Sin cutaway para m├íxima resonancia. Incrustaciones de n├ícar alrededor de la boca, m├ístil de caoba, fondo y aros de nogal. El est├índar de estudio para sonido cubano aut├®ntico.",
  ...
  },
  {
    ...
    desc_es: "Tres Cubano con tapa s├│lida de acacia. M├ístil de arce, diapas├│n y puente de acacia. Incluye funda de transporte. Afinaci├│n: G-B-E o G-C-E. Excelente relaci├│n calidad-precio para estudiantes y m├║sicos de gira.",
  ...
  },
  {
    ...
    desc_es: "Tres Cubano con cutaway para acceso a trastes superiores. Tapa de cedro, fondo y aros de sapeli, m├ístil de arce con diapas├│n de acacia. Sistema de pastilla incorporado. Afinaci├│n: G-B-E o G-C-E. Excelente opci├│n de gama media con electr├│nica lista para el escenario.",
  ...
  },
  {
    ...
    desc_es: "Tres Cubano premium con cutaway. Tapa de cedro, fondo y aros de nogal, m├ístil de arce con diapas├│n de acacia. Sistema de pastilla incorporado. El tres Thomann de m├ís alta gama para m├║sicos que necesitan acceso al cutaway y electr├│nica lista para el escenario.",
  ...
  },
  {
    ...
    reviews: 6789,
    badge: "bestSeller",
    desc: "The gateway to Fender's iconic sound. Alder body, maple neck with 9.5-inch radius fingerboard, and three Player Series pickups. The Strat that launched a thousand bands ├óÔé¼ÔÇØ from indie rock to Latin pop, this is the most versatile guitar money can buy.",
    desc_es: "La puerta de entrada al sonido ic├│nico de Fender. Cuerpo de aliso, m├ístil de arce con diapas├│n de radio 9.5 pulgadas y tres pastillas Player Series. La Strat que lanz├│ mil bandas ├óÔé¼ÔÇØ desde indie rock hasta pop latino, esta es la guitarra m├ís vers├ítil que el dinero puede comprar.",
  ...
  },
  {
    ...
    reviews: 5432,
    badge: "bestSeller",
    desc: "The working musician's guitar. Two Player Series single-coils deliver that unmistakable Tele twang ├óÔé¼ÔÇØ from Nashville to Havana, the Telecaster has defined country, rock, blues, and Latin music for over 70 years. Simple, rugged, and absolutely timeless.",
    desc_es: "La guitarra del m├║sico trabajador. Dos pastillas single-coil Player Series ofrecen ese inconfundible twang de Telecaster ├óÔé¼ÔÇØ desde Nashville hasta La Habana, la Telecaster ha definido el country, rock, blues y la m├║sica latina por m├ís de 70 a├▒os. Simple, robusta y absolutamente atemporal.",
  ...
  },
  {
    ...
    reviews: 3456,
    badge: "premium",
    desc: "Professional-grade Telecaster with V-Mod II pickups for enhanced clarity and punch. Deep C neck profile fits your hand like a glove. The Tele that bridges vintage soul with modern performance ├óÔé¼ÔÇØ ideal for session players and touring musicians.",
    desc_es: "Telecaster de grado profesional con pastillas V-Mod II para claridad y potencia mejoradas. Perfil de m├ístil Deep C que se adapta a tu mano como un guante. La Tele que une el alma vintage con el rendimiento moderno ├óÔé¼ÔÇØ ideal para m├║sicos de sesi├│n y giras.",
  ...
  },
  {
    ...
    desc_es: "La Stratocaster m├ís avanzada de Fender. Pastillas Ultra Noiseless, tal├│n esculpido para acceso a trastes superiores y diapas├│n de radio compuesto. Desde delicados acordes de jazz hasta desgarradores leads de rock latino, esta es la Strat definitiva para el profesional exigente.",
  ...
  },
  {
    ...
    reviews: 1890,
    badge: "recommended",
    desc: "The offset icon reborn. Player II pickups with the distinctive Jazzmaster tone ├óÔé¼ÔÇØ warm, round, and complex. The floating vibrato adds shimmer and depth. Loved by surf, indie, and alternative players worldwide. A cult classic that became a legend.",
    desc_es: "El icono offset renacido. Pastillas Player II con el distintivo tono Jazzmaster ├óÔé¼ÔÇØ c├ílido, redondo y complejo. El vibrato flotante a├▒ade brillo y profundidad. Amado por m├║sicos de surf, indie y alternativa mundialmente. Un cl├ísico de culto que se convirti├│ en leyenda.",
  ...
  },
  {
    ...
    reviews: 4567,
    badge: "legend",
    desc: "The bass that invented modern music. The P-Bass delivers that punchy, authoritative low-end that drives salsa, funk, rock, and Latin jazz. Split-coil pickup for rich, balanced tone. The foundation of every great rhythm section ├óÔé¼ÔÇØ from James Brown to Buena Vista.",
    desc_es: "El bajo que invent├│ la m├║sica moderna. El P-Bass ofrece ese golpe grave y autoritario que impulsa la salsa, el funk, el rock y el jazz latino. Pastilla split-coil para un tono rico y equilibrado. La base de cada gran secci├│n r├¡tmica ├óÔé¼ÔÇØ desde James Brown hasta Buena Vista.",
  ...
  },
  {
    ...
    title_es: "Fender CD-60S Ac├║stica",
    category: "guitars",
    price: 219,
    rating: 4.4,
    reviews: 18907,
    ...
    desc_es: "La ac├║stica que lo empez├│ todo para millones de m├║sicos. Tapa s├│lida de abeto con fondo y aros de caoba ofrece un tono c├ílido y equilibrado. El perfil de m├ístil f├ícil de tocar la convierte en la ac├║stica ideal para principiantes o compa├▒era de fogata. Calidad Fender a un precio imbatible.",
  ...
  },
  {
    ...
    desc_es: "El amplificador combo boutique por excelencia. 15 vatios de potencia todo-v├ílvulas a trav├®s de un altavoz Jensen de 12 pulgadas. EQ de tres bandas, reverb de resorte y fat boost lo convierten en el peque├▒o amplificador m├ís grabado de la historia. Desde clubes de blues hasta caf├®s de jazz latino, el Blues Junior ofrece un tono c├ílido y responsivo que hace sonar mejor a todo guitarrista.",
  ...
  },
  {
    ...
    reviews: 12345,
    badge: "bestSeller",
    desc: "The best-selling modeling amp in the world. 50 watts of power with five amp voicings ├óÔé¼ÔÇØ clean, crunch, lead, brown, and acoustic. Built-in effects including delay, reverb, chorus, and more. The Katana 50 is the ultimate practice and small-gig amp for guitarists who want versatility without complexity or cost.",
    desc_es: "El amplificador de modelado m├ís vendido del mundo. 50 vatios de potencia con cinco voces de amplificador ├óÔé¼ÔÇØ clean, crunch, lead, brown y ac├║stico. Efectos incorporados incluyendo delay, reverb, chorus y m├ís. El Katana 50 es el amplificador definitivo para pr├íctica y peque├▒os conciertos para guitarristas que quieren versatilidad sin complejidad ni costo.",
  ...
  },
  {
    ...
    desc_es: "El sonido del rock brit├ínico. 30 vatios de potencia todo-v├ílvulas a trav├®s de dos altavoces Celestion de 12 pulgadas. El ic├│nico brillo que defini├│ a The Beatles, Queen e innumerables bandas de rock brit├ínico. El canal Top Boost ofrece esa presencia cortante inconfundible. Para guitarristas que quieren el sonido de la historia del rock.",
  ...
  },
  {
    ...
    reviews: 4321,
    badge: "topQuality",
    desc: "The classic rock amplifier reimagined. 40 watts of all-tube power through a 12-inch Celestion V-type speaker. Two channels with classic gain and ultra gain for everything from clean blues to heavy rock. The DSL40CR is the quintessential Marshall sound ├óÔé¼ÔÇØ punchy mids, crunch, and that unmistakable British roar.",
    desc_es: "El amplificador de rock cl├ísico reimaginado. 40 vatios de potencia todo-v├ílvulas a trav├®s de un altavoz Celestion V-type de 12 pulgadas. Dos canales con ganancia cl├ísica y ultraganancia para todo, desde blues limpio hasta rock pesado. El DSL40CR es el sonido Marshall por excelencia ├óÔé¼ÔÇØ medios contundentes, crunch y ese rugido brit├ínico inconfundible.",
  ...
  },
  {
    ...
    desc_es: "El amplificador de bajo que defini├│ el rock and roll. 500 vatios de potencia Clase D en un cabezal ligero y port├ítil. Legendario tono Ampeg con EQ de 3 bandas, selector de frecuencia ultra-media y compresor incorporado. El PF-500 entrega ese retumbante extremo grave que impuls├│ Motown, el rock y la m├║sica latina durante d├®cadas. Comb├¡nalo con cualquier gabinete para obtener un tono de bajo cl├ísico instant├íneo.",
  ...
  },
  {
    ...
    desc_es: "El est├índar de la industria para inal├ímbricos asequibles. Sistema de doble canal con c├ípsulas PG58. Configuraci├│n simple con escaneo de frecuencia de un toque. Hasta 14 horas de bater├¡a. Rendimiento UHF confiable.",
  ...
  },
  {
    ...
    desc_es: "Inal├ímbrico profesional usado por artistas de gira mundialmente. Recepci├│n True Diversity para rendimiento sin cortes. 42 MHz de ancho de banda. C├ípsula e935 con claridad vocal de calidad broadcast. Construcci├│n met├ílica robusta.",
  ...
  },
  {
    ...
    desc_es: "Inal├ímbrico digital para el escenario profesional. Respuesta 20 Hz-20 kHz sin compresi├│n. Transmisi├│n digital patentada. C├ípsula SM58 legendaria para voces en vivo. Dante networking para Broadway, TV y giras.",
  ...
  },
  {
    ...
    desc_es: "Inal├ímbrico profesional nivel b├ísico de Sennheiser. Gesti├│n autom├ítica de frecuencia. C├ípsula e825 con sonido vocal claro. 10 horas de bater├¡a. Perfecto para lugares peque├▒os e iglesias.",
  ...
  },
  {
    ...
    desc_es: "Sistema inal├ímbrico multicanal profesional de AKG. Incluye receptor SR420, transmisor de mano HT420 con c├ípsula D5 y transmisor de petaca PT420. Excepcional duraci├│n de bater├¡a de 8 horas con una sola pila AA. Antenas desmontables para accesorios profesionales. Hasta 8 canales simult├íneos.",
  ...
  },
  {
    ...
    desc_es: "El pedal de overdrive m├ís famoso jam├ís creado. Del blues al rock, el growl con medios realzados ha moldeado el tono de la guitarra por d├®cadas.",
  ...
  },
  {
    ...
    desc_es: "El pedal de delay compacto definitivo. 11 modos incluyendo anal├│gico, cinta, reverso y loop. Hasta 40 segundos de looper. Durabilidad Boss y calidad de sonido impecable.",
  ...
  },
  {
    ...
    title_es: "Sintonizador Crom├ítico Boss TU-3",
    category: "pedals",
    price: 99,
    rating: 4.8,
    reviews: 34560,
    ...
    desc_es: "El afinador de pedal est├índar de la industria. Afinaci├│n crom├ítica precisa con pantalla brillante. True bypass, salida de corriente y construido para sobrevivir la carretera.",
  ...
  },
  {
    ...
    desc_es: "El pedal wah que defini├│ la guitarra rock. Circuito Crybaby cl├ísico con legendario tono de filtro barrido. De Hendrix a Kirk Hammett, este es el sonido del wah.",
  ...
  },
  {
    ...
    desc_es: "El pedal de reverb m├ís vers├ítil. 8 algoritmos m├ís ranuras TonePrint personalizables. De sala sutil a lavados ambientales et├®reos. Reverb de calidad de estudio en un pedal.",
  ...
  },
  {
    ...
    desc_es: "El pedal phaser cl├ísico. Tonos de fase ricos y giratorios desde movimiento sutil hasta barridos dram├íticos. Usado en innumerables discos.",
  ...
  },
  {
    ...
    title_es: "Yamaha FG800 Ac├║stica",
    category: "guitars",
    price: 229,
    rating: 4.6,
    reviews: 24560,
    ...
    desc_es: "La guitarra ac├║stica de mejor valor. Tapa s├│lida de abeto, fondo y aros de palo rosa. Tono rico y lleno que rivaliza con guitarras del doble de precio.",
  ...
  },
  {
    ...
    desc_es: "La mejor guitarra el├®ctrica para principiantes. Configuraci├│n HSS para versatilidad. Cuerpo s├│lido de aliso, m├ístil de arce. Toca y suena como guitarras del doble de precio.",
    img: "https://thumbs.static-thomann.de/thumb/thumb600x600/pics/prod/429087.jpg",
  ...
  },
  {
    ...
    desc_es: "La guitarra ac├║stica que defini├│ la m├║sica moderna. Tapa s├│lida de abeto Sitka, fondo y aros de palo rosa de la India. El est├índar con el que se miden todas las dem├ís guitarras ac├║sticas.",
  ...
  },
  {
    ...
    desc_es: "Altavoz PA activo profesional. 1000W de potencia pico, woofer de 12 pulgadas con tweeter de titanio. Dise├▒o ligero de solo 13.6 kg. DSP incorporado con preajustes.",
  ...
  },
  {
    ...
    desc_es: "El est├índar de la industria para refuerzo de sonido en vivo. 2000W de potencia pico. Extensi├│n de graves profunda, agudos impecables. Construcci├│n robusta, lista para la carretera.",
  ...
  },
  {
    ...
    title_es: "Inal├ímbrico Shure SM58",
    category: "live_sound",
    price: 399,
    rating: 4.7,
    reviews: 18900,
    ...
    desc_es: "La versi├│n inal├ímbrica del micr├│fono vocal en vivo m├ís ic├│nico. Rendimiento legendario de la c├ípsula SM58 sin el cable.",
  ...
  },
  {
    ...
    desc_es: "El est├índar de la industria para producci├│n de m├║sica electr├│nica y performance en vivo. Motor warp, integraci├│n Max for Live. Flujo de trabajo inigualable.",
  ...
  },
  {
    ...
    desc_es: "El DAW profesional de Apple para Mac. Grabaci├│n completa, secuenciaci├│n MIDI y mezcla. Incluye sintetizador Alchemy y packs de producci├│n.",
  ...
  },
  {
    ...
    desc_es: "La elecci├│n de los creadores de beats. Flujo de trabajo basado en patrones, piano roll intuitivo y actualizaciones gratuitas de por vida.",
  ...
  },
  {
    ...
    desc_es: "El est├índar de la industria de grabaci├│n. Usado en estudios profesionales mundialmente para tracking, edici├│n y mezcla. Esencial para post-producci├│n de audio.",
  ...
  },
  {
    ...
    desc_es: "El sistema completo de producci├│n musical. Edici├│n MIDI potente, correcci├│n de tono VariAudio, notaci├│n avanzada. Confiado por compositores y productores.",
  ...
  },
  {
    ...
    desc_es: "El flujo de trabajo m├ís r├ípido en un DAW. Arrastra y suelta todo, integraci├│n Melodyne incorporada. Plantillas inteligentes para inicio r├ípido.",
