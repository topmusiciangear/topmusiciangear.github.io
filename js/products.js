...
const storeIcons = {
  ...
  baxmusic: "<span style='display:inline-flex;flex-direction:column;align-items:center;justify-content:center;gap:2px;width:16px;height:16px;background:#c30067;color:#000;border-radius:2px;overflow:hidden;vertical-align:middle;font-weight:900;font-size:6px;line-height:1;'><span style='display:block;width:12px;height:2px;background:#000;border-radius:1px;'></span><span style='display:block;width:12px;height:2px;background:#000;border-radius:1px;'></span><span style='display:block;width:12px;height:2px;background:#000;border-radius:1px;'></span><span style='display:block;width:12px;height:2px;background:#000;border-radius:1px;'></span></span>",
