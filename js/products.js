...
const storeIcons = {
  ...
  baxmusic: "<span style='display:inline-flex;align-items:end;justify-content:center;gap:2px;width:16px;height:16px;background:#c30067;border-radius:2px;overflow:hidden;vertical-align:middle;padding:0 0 2px;'><span style='display:block;width:2px;height:6px;background:#000;border-radius:1px;'></span><span style='display:block;width:2px;height:10px;background:#000;border-radius:1px;'></span><span style='display:block;width:2px;height:14px;background:#000;border-radius:1px;'></span><span style='display:block;width:2px;height:8px;background:#000;border-radius:1px;'></span></span>",
