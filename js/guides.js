const guides = [
  ...
  },
  {
    ...
    sections: [
      ...
      {
        heading: "The Creative Universe: Native Instruments Komplete 15 Ultimate",
        heading_es: "El Universo Creativo: Native Instruments Komplete 15 Ultimate",
        content: "Komplete 15 Ultimate is the definitive Native Instruments collection — over 150 instruments and effects covering every sound imaginable. Kontakt 8 gives you the ultimate sampler platform with thousands of libraries. Massive X delivers cutting-edge wavetable synthesis. Guitar Rig 7 covers every amp and effect a guitarist needs. Session Strings and Cremona Quartet bring orchestral realism to your productions. The cinematic scoring tools, synthesizers, drums, and creative effects make this the most complete production toolkit on the market. At $1,199, it's the bundle that replaces a studio full of hardware. Combined with FabFilter for mixing and Soundtoys for effects, you have everything needed to produce, mix, and master professional music.",
        content_es: "Komplete 15 Ultimate es la colección definitiva de Native Instruments — más de 150 instrumentos y efectos que cubren cada sonido imaginable. Kontakt 8 te da la plataforma de sampler definitiva con miles de bibliotecas. Massive X ofrece síntesis wavetable de vanguardia. Guitar Rig 7 cubre cada amplificador y efecto que un guitarrista necesita. Session Strings y Cremona Quartet aportan realismo orquestal a tus producciones. Las herramientas de scoring cinematográfico, sintetizadores, baterías y efectos creativos hacen de este el kit de producción más completo del mercado. A $1,199, es el bundle que reemplaza un estudio lleno de hardware. Combinado con FabFilter para mezcla y Soundtoys para efectos, tienes todo lo necesario para producir, mezclar y masterizar música profesional.",
        products: [123]
      }
    ],
    conclusion: "Start with FabFilter Pro-Q 4 (part of the Total Bundle). Add Ozone 12 when you need mastering tools. Get Soundtoys when you want to get creative. Add Melodyne 5 when working with vocals. Get Komplete 15 Ultimate when you need the complete production toolkit. These five cover everything from surgical mixing to complete music production.",
    conclusion_es: "Empieza con FabFilter Pro-Q 4 (parte del Total Bundle). Añade Ozone 12 cuando necesites herramientas de masterización. Consigue Soundtoys cuando quieras ser creativo. Añade Melodyne 5 cuando trabajes con voces. Consigue Komplete 15 Ultimate cuando necesites el kit de producción completo. Estos cinco cubren todo, desde mezcla quirúrgica hasta producción musical completa.",
    verdict: "FabFilter Total Bundle if you can only buy one, Komplete 15 for production, Melodyne 5 for vocals",
    verdict_es: "FabFilter Total Bundle si solo puedes comprar uno, Komplete 15 para producción, Melodyne 5 para voces",
