...
function renderGuideDetailFromData(id) {
  ...
  grid.innerHTML = `
    <div class="guide-detail">
      ...
      ${(function(){ var faqs = getGuideFaqs(guide); if (!faqs || !faqs.length) return ''; return '<div class="guide-faq"><h2 class="guide-faq-title">' + (isEs ? 'Preguntas Frecuentes' : 'Frequently Asked Questions') + '</h2><div class="guide-faq-list">' + faqs.map(function(f){ return '<div class="guide-faq-item"><button class="guide-faq-question" onclick="var a=this.nextElementSibling;if(a.dataset.open){a.style.maxHeight=\'0px\';a.style.paddingBottom=\'0px\';a.style.paddingTop=\'0px\';a.dataset.open=\'\';this.classList.remove(\'open\');setTimeout(function(){if(!a.dataset.open){a.style.display=\'none\';a.style.paddingTop=\'\';a.style.paddingBottom=\'\'}},300)}else{this.classList.add(\'open\');a.style.display=\'block\';a.style.visibility=\'hidden\';a.style.paddingTop=\'0px\';a.style.paddingBottom=\'0px\';a.style.maxHeight=\'none\';void a.offsetHeight;var h=a.scrollHeight;a.style.maxHeight=\'0px\';a.style.visibility=\'\';void a.offsetHeight;a.style.maxHeight=(h+16)+\'px\';a.style.paddingTop=\'\';a.style.paddingBottom=\'\';a.dataset.open=\'1\'}">' + (isEs && f.q_es ? f.q_es : f.q) + '<span class="guide-faq-icon">+</span></button><div class="guide-faq-answer" style="display:none;max-height:0;overflow:hidden">' + (isEs && f.a_es ? f.a_es : f.a) + '</div></div>'; }).join('') + '</div></div>'; })()}
