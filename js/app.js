...
function renderMySetup() {
  ...
  const gear = [
    { icon: '<svg data-fa="waveform" class="icon" viewBox="0 0 24 24" width="1em" height="1em" fill="currentColor"><rect x="1" y="5" width="22" height="14" rx="2"/><rect x="4" y="9" width="3" height="6" rx="0.8" fill="currentColor" opacity="0.6"/><circle cx="14" cy="12" r="3"/><circle cx="14" cy="12" r="1.2" fill="currentColor"/><rect x="19" y="10" width="1.5" height="4" rx="0.5" fill="currentColor" opacity="0.6"/></svg>', title: "Focusrite Scarlett 2i2 4th Gen", descKey: "setupItem1Desc", asin: "B0C5JRTS3Y" },
