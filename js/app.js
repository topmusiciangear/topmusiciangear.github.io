  ...
  return `
    <div class="guide-product-card">
      ...
      <div class="guide-product-card-body">
        ...
        <div class="guide-product-card-currency-note">${currentLang === 'es' ? '<strong>⚠️ Atención:</strong> Los precios pueden variar según tu geolocalización; el precio final se confirma en tu moneda local al pagar. La disponibilidad varía según la tienda y el stock. zZounds envía solo dentro de EE.UU.' : '<strong>⚠️ Attention:</strong> Prices may vary depending on your location; final price confirmed in your local currency at checkout. Availability varies by retailer and stock. zZounds ships within the U.S. only.'}</div>
      </div>
    </div>
  `;
}
