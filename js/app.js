...
function renderMySetup() {
  ...
  container.innerHTML = gear.map(g => `
    <a href="${g.asin ? 'https://www.amazon.com/dp/' + g.asin + '?tag=topmusicg-20' : g.url}" target="_blank" rel="noopener noreferrer sponsored" class="setup-item" style="text-decoration:none;color:inherit">
