  ...
  return `
    <div class="guide-product-card">
      ...
      <div class="guide-product-card-body">
        ...
        <button class="guide-product-card-desc-toggle" onclick="var d=this.previousElementSibling;d.classList.toggle('expanded');this.textContent=d.classList.contains('expanded')?'\u2212':'+'">+</button>
...
function renderGuideDetailFromData(id) {
  ...
  `;
  document.querySelectorAll('.guide-product-card-desc').forEach(function(e){var b=e.nextElementSibling;if(b&&b.classList.contains('guide-product-card-desc-toggle')&&e.scrollHeight<=e.clientHeight)b.remove()});
...
function renderMySetup() {
  ...
  const gear = [
    ...
    { icon: '<svg data-fa="waveform" class="icon fa-solid fa-waveform" viewBox="0 0 640 512" width="1em" height="1em" fill="currentColor"><path d="M0 240c0-17.7 14.3-32 32-32s32 14.3 32 32v32c0 17.7-14.3 32-32 32s-32-14.3-32-32V240zm96-64c0-17.7 14.3-32 32-32s32 14.3 32 32V336c0 17.7-14.3 32-32 32s-32-14.3-32-32V176zm128-96c17.7 0 32 14.3 32 32V400c0 17.7-14.3 32-32 32s-32-14.3-32-32V112c0-17.7 14.3-32 32-32zm128 32c0-17.7 14.3-32 32-32s32 14.3 32 32V368c0 17.7-14.3 32-32 32s-32-14.3-32-32V112zm128 96c17.7 0 32 14.3 32 32v64c0 17.7-14.3 32-32 32s-32-14.3-32-32V240c0-17.7 14.3-32 32-32z"></path></svg>', title: "Ableton Live 12 Suite", descKey: "setupItem6Desc", asin: "B0CQXNY528" }
  ];
  container.innerHTML = gear.map(g => `
    <a href="https://www.amazon.${dom}/dp/${g.asin}?tag=topmusicg-20" target="_blank" rel="noopener noreferrer sponsored" class="setup-item" style="text-decoration:none;color:inherit">
...
document.addEventListener("DOMContentLoaded", () => {
  ...
  document.getElementById("productSearchInput")?.addEventListener("input", e => {
    ...
    results.querySelectorAll('.guide-product-card-desc').forEach(function(e){var b=e.nextElementSibling;if(b&&b.classList.contains('guide-product-card-desc-toggle')&&e.scrollHeight<=e.clientHeight)b.remove()});
    }, 250);
  });
