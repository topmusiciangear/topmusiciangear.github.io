...
function amazonUrl(asin) {
  var lang = (navigator.language || 'en-US').toLowerCase().replace(/-/g, '_');
  var map = { en_gb: 'co.uk', en_ie: 'co.uk', de_de: 'de', de_at: 'de', de_ch: 'de', fr_fr: 'fr', fr_be: 'fr', fr_ch: 'fr', it_it: 'it', es_es: 'es', ja_jp: 'co.jp', en_ca: 'ca', fr_ca: 'ca', en_au: 'com.au' };
  var domain = map[lang] || 'com';
  return 'https://www.amazon.' + domain + '/dp/' + asin + '?tag=topmusicg-20';
}
function renderMySetup() {
  ...
  container.innerHTML = gear.map(g => `
    <a href="${amazonUrl(g.asin)}" target="_blank" rel="noopener noreferrer sponsored" class="setup-item" style="text-decoration:none;color:inherit">
