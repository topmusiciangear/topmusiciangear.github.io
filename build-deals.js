...
const buildPage = (lang) => {
  ...
  const navDropdown = `<div class="nav-dd">
    ...
    <div class="nav-dd-panel" role="menu">
      ...
      <a class="nav-dd-link" href="https://www.zzounds.com/a--925521/lp/new-products/219" target="_blank" rel="noopener noreferrer sponsored"><img src="img/zzounds-icon.png" alt="" class="nav-dd-link-icon">zZounds</a>
    </div>
  </div>`;
...
`;
  ...
  const storeMeta = {
    ...
    'Music Store': { color: '#c0c0c0', mark: '<img src="img/musicstore-icon.png" alt="Music Store" style="width:auto;height:10px">' },
    'zZounds': { color: '#1a3a5c', mark: '<img src="img/zzounds-icon.png" alt="zZounds" width="128" height="128" style="width:auto;height:10px">' }
  };
  const slugToName = {
    andertons: 'Andertons',
  ...
  const stores = [
    ...
    { name: 'zZounds', url: 'https://www.zzounds.com/a--925521/blowouts' }
  ];
