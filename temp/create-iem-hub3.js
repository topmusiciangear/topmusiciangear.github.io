...
const newGuide={
  ...
  sections: [
    { title: "Flagship Reference IEMs for Touring & Studio", title_es: "Referencias Insignia para Giras y Estudio", products: [{ product: 269 }] },
    { title: "Industry Standards & Workhorses (Mid-Range)", title_es: "Estándares de la Industria y Caballos de Batalla (Gama Media)", products: [] },
    { title: "Professional Entry-Level Options (Budget-Friendly)", title_es: "Opciones Profesionales de Entrada (Gama Económica)", products: [] },
    { title: "Wireless IEM Systems for Stage", title_es: "Sistemas Inalámbricos In-Ear para Escenario", products: [{product:266},{product:347},{product:348},{product:349},{product:350},{product:362}] }
  ],
  ...
  productTable: { title: "Best In-Ear Monitors Compared", title_es: "Comparativa de los Mejores Monitores In-Ear", columns: [{ title: "Shure SE846 Gen 2", title_es: "Shure SE846 Gen 2" },{ title: "Sennheiser EW IEM G4", title_es: "Sennheiser EW IEM G4" },{ title: "Xvive U4 Wireless", title_es: "Xvive U4 Inalámbrico" },{ title: "Sennheiser XSW IEM", title_es: "Sennheiser XSW IEM" }] },
  verdictProCons: {},
