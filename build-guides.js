...
<body style="margin:0;padding:0;">
  ...
  <main id="mainContent">
    ...
    <div class="guide-detail">
      ...
      <p class="guide-product-card-currency-note">${isEs ? '<strong>⚠️ Atención:</strong> Los precios pueden variar según tu geolocalización; el total final se confirma en tu moneda local al pagar. Algunas tiendas cobran envío — otras lo ofrecen gratis a partir de un importe mínimo — y algunas solo envían dentro de EE. UU. Cada tienda aplica sus propias reglas y condiciones: nosotros solo te mostramos el precio del producto.' : '<strong>⚠️ Attention:</strong> Prices may vary depending on your location; your final total is confirmed in your local currency at checkout. Some stores charge shipping — others offer free shipping above a minimum order — and some ship only within the U.S. Each store has its own rules and terms: we only show you the product\u2019s price.'}</p>
      ...
      ${productCards ? `<p class="guide-product-card-currency-note">${isEs ? '<strong>⚠️ Atención:</strong> Los precios pueden variar según tu geolocalización; el total final se confirma en tu moneda local al pagar. Algunas tiendas cobran envío — otras lo ofrecen gratis a partir de un importe mínimo — y algunas solo envían dentro de EE. UU. Cada tienda aplica sus propias reglas y condiciones: nosotros solo te mostramos el precio del producto.' : '<strong>⚠️ Attention:</strong> Prices may vary depending on your location; your final total is confirmed in your local currency at checkout. Some stores charge shipping — others offer free shipping above a minimum order — and some ship only within the U.S. Each store has its own rules and terms: we only show you the product\u2019s price.'}</p>` : ''}
