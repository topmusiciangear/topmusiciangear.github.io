...
const TEST_SHOP_BTN = {
  ...
  7: { prices: {  reverb: "$4,234.33",amazon: '$4,234.33',  zzounds: '$2,799.00', andertons: '£2,499.00'  ,
      gear4music: "£2,499.00"} },
  8: { prices: { reverb: "$2,499.00", amazon: '$2,499.00', andertons: '£2,299.00', musicstore: "€2,628.00" } },
  ...
  92: { prices: { amazon: '$849.00' } , oos: ['zzounds', 'andertons'] },
  ...
  105: { prices: {  reverb: "$549.00",amazon: '$549.00', zzounds: '$549.00', andertons: '£436.00'  , gear4music: "£469.00", musicstore: "€1,621.00" } },
...
8: { prices: { reverb: "$2,499.00",amazon: '$2,499.00' } , andertons: '£2,299.00' },
  ...
  120: { prices: {  pluginboutique: '$99.00', reverb: "$99.00", zzounds: '$249.00'  ,
      gear4music: "£74.99", amazon: '$119.00'} , oos: ['andertons'] },
  ...
  132: { prices: {  andertons: '£859.00'  ,
      gear4music: "£829.00", amazon: '$949.99'} },
  ...
  166: { prices: {  andertons: '£319.00'  ,
      gear4music: "£349.00", amazon: '$399.00'} , oos: ['zzounds'] },
  ...
  210: { prices: {  reverb: "$219.00", amazon: '$219.00', zzounds: '$219.00', andertons: '£149.00'  , gear4music: "£149.50", musicstore: "€399.00" } },
  211: { prices: {  reverb: "$399.00", amazon: '$399.00', zzounds: '$499.99', andertons: '£372.00'  , musicstore: "€549.00" } },
  212: { prices: {  reverb: "$219.00", amazon: '$219.00', zzounds: '$219.00', andertons: '£193.00'  , musicstore: "€379.00" } },
  ...
  220: { prices: {  reverb: "$399.99", zzounds: '$949.00'  , amazon: '$949.00'} , oos: ['andertons'] },
  ...
  228: { prices: {  reverb: "$214.00",amazon: '$214.00',  zzounds: '$219.00'  , musicstore: "€399.00" } },
  229: { prices: {  reverb: "$249.00",amazon: '$249.00', zzounds: '$249.00'  , andertons: '£249.00'  , musicstore: "€899.00" } },
  ...
  238: { prices: {   pluginboutique: '$99.00', reverb: "$99.00"     ,
      gear4music: "£39.00", amazon: '$99.00'} , oos: ['andertons'] },
...
273: { prices: { reverb: "$879.99", amazon: '$879.99', andertons: '£699.00', gear4music: "£706.00", musicstore: "€739.00" } },
  ...
  297: { prices: { reverb: "$159.00", amazon: '$159.00', zzounds: '$146.00', andertons: '£122.00', gear4music: "£139.25", musicstore: "€392.00" } },
  ...
  345: { prices: {  reverb: "$239.40",amazon: '$239.40',  zzounds: '$239.40'  , andertons: '£199.00'  , musicstore: "€449.00" } },
  346: { prices: {  reverb: "$187.51",amazon: '$187.51', zzounds: '$219.00'  } , oos: ['andertons'] },
  347: { prices: {  zzounds: '$249.99', andertons: '£175.00'  , amazon: '$199.99'} },
  348: { prices: {  zzounds: '$599.99', andertons: '£433.00'  , amazon: '$479.99'} },
  ...
  354: { prices: {  reverb: "$799.99", andertons: '£379.00'  , amazon: '$599.00'} , oos: ['zzounds'] },
...
function shopButtonsTest(p, lang) {
  ...
  const rows = order.map(k => {
    ...
    const pr = prices[k] ? '<span style="margin-left:auto;display:flex;align-items:baseline;gap:6px;white-space:nowrap">' + ((k === 'gear4music') ? '' : (k === 'reverb' || k === 'musicstore') ? '<span style="color:#a8a8a8;font-size:12px;font-weight:600">' + t('aprox.', 'approx.') + '</span>' : '') + '<span style="font-weight:700;color:#fff">' + prices[k] + '</span></span>' : '';
