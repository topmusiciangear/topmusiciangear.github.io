  ...
  <main id="mainContent">
    ...
    <div class="guide-detail">
      ...
      <div class="guide-product-card-currency-note">
        ...
        <div class="note-row"><span class="note-icon">🌍</span><span>${isEs ? 'Si un producto no está disponible o el enlace abre otra página, puede deberse a restricciones regionales o a tu geolocalización. Según tu ubicación, una tienda puede mostrar el artículo como agotado, no venderlo en tu país o redirigirte a un producto similar al que buscas — ese comportamiento lo decide la propia tienda, no nosotros. Si ocurre, revisa las otras tiendas que mostramos, cada una con su propio inventario. Algunas como Gear4music o Music Store te permiten cambiar tu región desde su sitio para ver precios y disponibilidad en tu país.' : 'If a product shows as unavailable or a link opens a different page, it may be due to regional restrictions or geolocation. Depending on your location, a store may show the item as out of stock, may not sell it in your country, or may redirect you to a similar product on their site — this is decided by the store itself, not by us. If that happens, check the other stores we list, each with its own inventory. Some like Gear4music or Music Store let you switch your region on their site to see prices and availability in your country.'}</span></div>
      </div>
