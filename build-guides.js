...
const TEST_SHOP_BTN = {
  ...
  96: { prices: { reverb: "$99.00", amazon: "$99.00", zzounds: "$99.99", andertons: "£109.99", gear4music: "£110.00" , musicstore: "€608.10"} },
  97: { prices: { reverb: "$186.20", amazon: "$186.20", zzounds: "$197.99", andertons: "£174.99", gear4music: "£166.00" , musicstore: "€1,444.00"} },
  98: { prices: { reverb: "$103.50", amazon: "$103.50", zzounds: "$109.99", andertons: "£89.99", gear4music: "£84.20" , musicstore: "€468.00"} },
  ...
  118: { prices: { pluginboutique: "$1999.00", reverb: "$1999.00" }, oos: ["gear4music", "musicstore"] },
  ...
  162: { prices: { amazon: "na", andertons: "£799.00", gear4music: "£599.00" }, oos: ["zzounds", "musicstore"] },
  163: { prices: { zzounds: "$599.00", andertons: "£349.00" }, oos: ["gear4music", "musicstore"] },
  164: { prices: { reverb: "$649.00", amazon: "$649.00", zzounds: "$649.00", andertons: "£229.00", gear4music: "£599.00" } , oos: ["musicstore"]},
  165: { prices: { zzounds: "$649.00", gear4music: "£579.00", amazon: "$599.00" }, oos: ["andertons", "musicstore"] },
  ...
  220: { prices: { reverb: "$399.99", zzounds: "$949.00", amazon: "$949.00" }, oos: ["andertons", "gear4music", "musicstore"] },
  ...
  227: { prices: { reverb: "$199.95", amazon: "$199.95", zzounds: "$199.95", andertons: "£149.00" }, oos: ["gear4music", "musicstore"] },
  ...
  239: { prices: { reverb: "$499.00", amazon: "$499.00", zzounds: "$488.00", andertons: "£390.00", gear4music: "£899" , musicstore: "€3,692.00"} },
  ...
  255: { prices: { reverb: "$449.99", amazon: "$449.99", zzounds: "$519.99", andertons: "£452.00", gear4music: "£549" , musicstore: "€1,958.00"} },
  ...
  300: { prices: { reverb: "$599.00", amazon: "$599.00", zzounds: "$599.00", andertons: "£499.00" }, oos: ["gear4music", "musicstore"] },
  ...
  310: { prices: { reverb: "$319.99", amazon: "$319.99", zzounds: "$319.99", gear4music: "£229" }, oos: ["andertons", "musicstore"] },
  ...
  318: { prices: { reverb: "$2199.99", amazon: "$2199.99", zzounds: "$2,199.99", andertons: "£1,699.00" }, oos: ["gear4music", "musicstore"] },
  ...
  329: { prices: { reverb: "$199.00", amazon: "$199.00", zzounds: "$229.00", andertons: "£164.00" }, oos: ["gear4music", "musicstore"] },
  ...
  332: { prices: { reverb: "$599.00", amazon: "$599.00", zzounds: "$599.00", andertons: "£399.00" }, oos: ["gear4music", "musicstore"] },
  333: { prices: { reverb: "$459.99", amazon: "$459.99", andertons: "£249.00" }, oos: ["gear4music", "musicstore"] },
  334: { prices: { reverb: "$3,299.99", amazon: "$3,299.99", zzounds: "$3,299.99", andertons: "£1,499.00" }, oos: ["gear4music", "musicstore"] },
  335: { prices: { reverb: "$999.99", amazon: "$999.99", zzounds: "$744.95", andertons: "£649.00" }, oos: ["gear4music", "musicstore"] },
  336: { prices: { reverb: "$249.99", amazon: "$249.99", zzounds: "$249.99" }, oos: ["andertons", "gear4music", "musicstore"] },
  ...
  339: { prices: { reverb: "$999.00", amazon: "$999.00", zzounds: "$999.00", andertons: "£949.00" }, oos: ["gear4music", "musicstore"] },
  ...
  346: { prices: { reverb: "$187.51", amazon: "$187.51", zzounds: "$219.00" }, oos: ["andertons", "gear4music", "musicstore"] },
  347: { prices: { zzounds: "$249.99", andertons: "£175.00", amazon: "$199.99" }, oos: ["gear4music", "musicstore"] },
  348: { prices: { zzounds: "$599.99", andertons: "£433.00", amazon: "$479.99" }, oos: ["gear4music", "musicstore"] },
  349: { prices: { zzounds: "$1,249.00", andertons: "£899.00", amazon: "$1,090.00", gear4music: "£881" } , oos: ["musicstore"]},
  350: { prices: { zzounds: "$228.99", amazon: "$228.99", andertons: "£189.00" } , oos: ["musicstore"]},
  352: { prices: { reverb: "$189.00", amazon: "$189.00", zzounds: "$249.99", andertons: "£149.00" }, oos: ["gear4music", "musicstore"] },
  353: { prices: { reverb: "$529.99", amazon: "$529.99" }, oos: ["andertons", "gear4music", "musicstore"] },
  354: { prices: { reverb: "$799.99", andertons: "£379.00", amazon: "$599.00" }, oos: ["zzounds", "gear4music", "musicstore"] },
  355: { prices: { amazon: "na", andertons: "£399.00" }, oos: ["zzounds", "amazon", "gear4music", "musicstore"] },
  356: { prices: { reverb: "$199.99", amazon: "$199.99" }, oos: ["andertons", "gear4music", "musicstore"] },
  357: { prices: { reverb: "$599.99", amazon: "$599.99", andertons: "£499.00" }, oos: ["gear4music", "musicstore"] },
  358: { prices: { reverb: "$189.00", amazon: "$189.00", zzounds: "$189.00" }, oos: ["andertons", "musicstore"] },
  359: { prices: { reverb: "$94.99", amazon: "$94.99" }, oos: ["andertons", "gear4music", "musicstore"] },
  360: { prices: { reverb: "$1499.00", amazon: "$1499.00", zzounds: "$1,499.00" }, oos: ["andertons", "musicstore"] },
  361: { prices: { reverb: "$999.00", amazon: "$999.00", zzounds: "$999.99", andertons: "£829.00" }, oos: ["gear4music", "musicstore"] },
