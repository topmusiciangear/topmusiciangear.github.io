...
<script>(function(){try{var a=localStorage.getItem('tmg_v');fetch('/version.txt?t='+Date.now()).then(function(r){return r.text()}).then(function(b){if(!a){localStorage.setItem('tmg_v',b);return}if(a!==b){localStorage.setItem('tmg_v',b);location.reload(true)}})}catch(e){}})()</script>
