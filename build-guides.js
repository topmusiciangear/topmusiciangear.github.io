...
{prices:{amazon:"$749.00",andertons:"£599.00",gear4music:"£529.00",musicstore:"€503.36"}},
  ...
  114: {prices:{gear4music:"£479.00",amazon:"$579.99",andertons:"£299.00",zzounds:"$579.99",musicstore:"€549.00",pluginboutique:"$579.99"}},
  ...
  492: {prices:{zzounds:"$449.99",amazon:"$328.98",andertons:"£399.00",gear4music:"£369.00",musicstore:"€335.30"}},
   ...
   498: {prices:{zzounds:"$350.00",gear4music:"£310.00",musicstore:"€246.00"}},
  ...
  <main id="mainContent">
    ...
    <div class="guide-detail">
      ...
      <div class="guide-product-card-currency-note">
        ...
        <div class="note-row"><span class="note-icon">🌍</span><span>${isEs ? 'Si un producto no está disponible, puede deberse a restricciones regionales. Según tu ubicación, una tienda puede mostrar el artículo como agotado, no venderlo en tu país o redirigirte a un producto similar al que buscas — ese comportamiento lo decide la propia tienda, no nosotros. Si ocurre, revisa las otras tiendas que mostramos, cada una con su propio inventario. Algunas como Gear4music o Music Store te permiten cambiar tu región desde su sitio para ver precios y disponibilidad en tu país.' : 'If a product shows as unavailable, it may be due to regional restrictions. Depending on your location, a store may show the item as out of stock, may not sell it in your country, or may redirect you to a similar product on their site — this is decided by the store itself, not by us. If that happens, check the other stores we list, each with its own inventory. Some like Gear4music or Music Store let you switch your region on their site to see prices and availability in your country.'}</span></div>
      </div>
