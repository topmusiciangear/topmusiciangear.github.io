...
function buildGuidePage(guide, lang, idx) {
  ...
  const authorBoxHtml = `<div class="guide-author-box">
    ...
    <div class="guide-author-box-body">
      ...
      <p class="guide-author-box-bio">${isEs ? 'Músico de directo y de sesión con más de 20 años sobre los escenarios de todo el mundo. La mayoría del equipo que recomiendo lo he usado yo mismo, en giras, estudios profesionales o en mi propio estudio.' : 'Touring and session musician with 20+ years on stages around the world. Most of the gear I recommend here I have used myself, on tours, in professional studios, or in my own studio.'}</p>
