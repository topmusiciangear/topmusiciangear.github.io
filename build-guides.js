...
function shopButtonsTest(p, lang) {
  ...
  const fallbackKey = safeAvail[0] || avail[0] || 'zzounds';
  const primaryStoreKey = isLogic ? 'official' : isPlugins ? 'pluginboutique' : isUsa ? 'zzounds' : hasAmazon ? 'amazon' : fallbackKey;
