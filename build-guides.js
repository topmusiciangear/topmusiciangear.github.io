    ...
    <div class="header-inner">
      ...
      <div class="header-right">
        ...
        <div class="lang-switcher">
          <button class="lang-btn ${isEs ? '' : 'active'}" title="English" onclick="location.href='${isEs ? `/guides/${guide.id}.html` : '#'}'"><svg class="lang-flag" viewBox="0 0 640 480" width="20" height="15"><rect width="640" height="480" fill="#fff"/><rect width="80" height="480" x="280" fill="#ce1124"/><rect width="640" height="80" y="200" fill="#ce1124"/></svg></button>
