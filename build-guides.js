...
'.hero-inner{font-family:-apple-system,BlinkMacSystemFont,"Segoe UI",sans-serif;max-width:960px;margin:0 auto;position:relative;z-index:1;display:flex;flex-direction:column;align-items:center;justify-content:center;min-height:calc(100vh - 64px)}',
    ...
    '.guide-comp-table{width:100%;border-collapse:separate;border-spacing:0;margin:24px 0;font-size:14px;contain:layout style}',
    ...
    '.guide-comp-scroll{overflow-x:auto;-webkit-overflow-scrolling:touch;scrollbar-width:thin;scrollbar-color:var(--accent) var(--surface);flex:1 1 auto;min-width:0}.guide-comp-scroll::-webkit-scrollbar{height:10px}.guide-comp-scroll::-webkit-scrollbar-track{background:var(--surface);border-radius:6px}.guide-comp-scroll::-webkit-scrollbar-thumb{background:var(--accent);border-radius:6px}.guide-comp-scroll::-webkit-scrollbar-thumb:hover{background:var(--accent-dark)}.guide-comp-scroll-wrap{display:flex;align-items:center;gap:0;position:relative}.guide-comp-arrow{flex:0 0 auto;width:38px;height:38px;background:none;border:none;color:#fff;cursor:pointer;display:flex;align-items:center;justify-content:center;transition:color .2s}.guide-comp-arrow:hover{color:var(--accent)}.guide-comp-arrow svg{width:16px;height:16px;filter:drop-shadow(0 0 4px rgba(0,0,0,.5))}.guide-comp-arrow-right svg{transform:rotate(180deg)}',
    '@media(max-width:768px){.guide-comp-table{font-size:14px}.guide-comp-table td{padding:3px 4px}.guide-comp-table th{white-space:nowrap;padding:5px 4px}.guide-comp-title{font-size:17px;margin:4px 0 8px}.guide-comp-scroll-wrap{gap:0}.guide-comp-arrow{position:absolute;top:50%;transform:translateY(-50%);z-index:5;background:none;border:none;color:#fff;cursor:pointer;font-size:22px;line-height:1;padding:2px;box-shadow:none;-webkit-tap-highlight-color:transparent;width:auto;height:auto;display:inline-flex;align-items:center;justify-content:center}.guide-comp-arrow:hover,.guide-comp-arrow:active{color:var(--accent)}.guide-comp-arrow svg{width:1em;height:1em;filter:drop-shadow(0 0 6px rgba(0,0,0,.6))}.guide-comp-arrow-left{left:-27px}.guide-comp-arrow-right{right:-27px}}',
    ...
    <div class="guide-detail">
      ...
      ${guide.comparison ? `<div class="guide-comp-wrap">
        ...
        <div class="guide-comp-scroll-wrap">
          <button type="button" class="guide-comp-arrow guide-comp-arrow-left" onclick="var s=this.parentNode.querySelector('.guide-comp-scroll');s.scrollBy({left:-Math.max(240,s.clientWidth*0.7),behavior:'smooth'})" aria-label="${isEs ? 'Desplazar a la izquierda' : 'Scroll left'}">${icon('arrow-left', 'fa-solid')}</button>
          ...
          <button type="button" class="guide-comp-arrow guide-comp-arrow-right" onclick="var s=this.parentNode.querySelector('.guide-comp-scroll');s.scrollBy({left:Math.max(240,s.clientWidth*0.7),behavior:'smooth'})" aria-label="${isEs ? 'Desplazar a la derecha' : 'Scroll right'}">${icon('arrow-left', 'fa-solid')}</button>
        </div>
      </div>` : ''}
      ${guide.productTable ? (function(){
        ...
        return '<div class="guide-comp-wrap"><h2 class="guide-comp-title">' + (isEs && guide.productTable.title_es ? guide.productTable.title_es : (guide.productTable.title || (isEs ? 'Comparativa de Productos' : 'Product Comparison'))) + '</h2><div class="guide-comp-scroll-wrap"><button type="button" class="guide-comp-arrow guide-comp-arrow-left" onclick="var s=this.parentNode.querySelector(\'.guide-comp-scroll\');s.scrollBy({left:-Math.max(240,s.clientWidth*0.7),behavior:\'smooth\'})" aria-label="' + (isEs ? 'Desplazar a la izquierda' : 'Scroll left') + '">' + icon('arrow-left', 'fa-solid') + '</button><div class="guide-comp-scroll"><table class="guide-comp-table"><thead><tr><th></th>' + headers + '</tr></thead><tbody>' + body + '</tbody></table></div><button type="button" class="guide-comp-arrow guide-comp-arrow-right" onclick="var s=this.parentNode.querySelector(\'.guide-comp-scroll\');s.scrollBy({left:Math.max(240,s.clientWidth*0.7),behavior:\'smooth\'})" aria-label="' + (isEs ? 'Desplazar a la derecha' : 'Scroll right') + '">' + icon('arrow-left', 'fa-solid') + '</button></div></div>';
      })() : ''}
      ...
      <script>setTimeout(function(){document.querySelectorAll('.guide-product-card-desc').forEach(function(e){var b=e.nextElementSibling;if(b&&b.classList.contains('guide-product-card-desc-toggle')&&e.scrollHeight<=e.clientHeight)b.remove()});document.querySelectorAll('.guide-comp-wrap').forEach(function(w){var s=w.querySelector('.guide-comp-scroll');if(!s)return;if(s.scrollWidth<=s.clientWidth+1){var l=w.querySelector('.guide-comp-arrow-left'),r=w.querySelector('.guide-comp-arrow-right');if(l)l.style.display='none';if(r)r.style.display='none'}});document.querySelectorAll('.guide-comp-scroll').forEach(function(s){s.addEventListener('scroll',function(){var w=s.closest('.guide-comp-wrap');if(!w)return;var l=w.querySelector('.guide-comp-arrow-left'),r=w.querySelector('.guide-comp-arrow-right');if(l)l.style.opacity=s.scrollLeft<=2?'0.25':'1';if(r)r.style.opacity=s.scrollLeft>=s.scrollWidth-s.clientWidth-2?'0.25':'1'})})},100)</script>
