...
const TEST_SHOP_BTN = {
  ...
  2: { prices: {  amazon: '$3,750.00', zzounds: '$3,995.00', reverb: "$3,750.00", andertons: '£3,007.00'  ,
      gear4music: "£2,908.40", musicstore: "€2,999.00" } },
  ...
  22: { prices: {  reverb: "$1175.00",amazon: '$1175.00',  andertons: '£959.00'  ,
      gear4music: "£812.00"} , oos: ['zzounds'] , musicstore: "€879.00" },
  23: { prices: {  reverb: "$199.99",amazon: '$199.99', andertons: '£129.00'  ,
      gear4music: "£129.00"} , oos: ['zzounds'] , musicstore: "€149.00" },
  ...
  28: { prices: {   pluginboutique: '$299.00', andertons: '£126.00', reverb: "$299.00"     ,
      gear4music: "£271.00"} , oos: ['musicstore']},
  29: { prices: {   pluginboutique: '$1069.00', andertons: '£639.00', reverb: "$1069.00", zzounds: '$1,069.00'     ,
      gear4music: "£769.00"} , oos: ['musicstore']},
  30: { prices: {   pluginboutique: '$499.00', andertons: '£479.00', reverb: "$499.00"     ,
      gear4music: "£479.00"} , oos: ['musicstore']},
  32: { prices: {   pluginboutique: '$599.00', reverb: "$599.00"     ,
      gear4music: "£489.00"} },
  33: { prices: {  reverb: "$749.99",amazon: '$749.99', zzounds: '$749.99', andertons: '£659.00'  ,
      gear4music: "£656.00"} , oos: ['musicstore']},
  34: { oos: ['zzounds'] },
  39: { prices: {  amazon: 'na'  , andertons: '£42.00'  ,
      gear4music: "£53.50",
      gear4music: "£53.50"} , oos: ['zzounds'] , musicstore: "€148.00" },
  42: { prices: {  reverb: "$1299.99",amazon: '$1299.99',  zzounds: '$1,299.99', andertons: '£1,052.00'  ,
      gear4music: "£1,039.00"} , oos: ['musicstore']},
  ...
  56: { prices: {  reverb: "$169.00",amazon: '$169.00', zzounds: '$199.99', andertons: '£149.00'  ,
      gear4music: "£129.00", musicstore: "€72.00" } },
  57: { prices: {  reverb: "$139.80",amazon: '$139.80',  andertons: '£134.00'  ,
      gear4music: "£125.00"} , oos: ['zzounds'] , musicstore: "€144.50" },
  58: { prices: {  reverb: "$94.99",amazon: '$94.99',  zzounds: '$108.99', andertons: '£54.00'  ,
      gear4music: "£54.40"} , oos: ['musicstore']},
  59: { prices: { amazon: '$165.99',  andertons: '£77.00'  ,
      gear4music: "£77.40"} , oos: ['zzounds', 'musicstore'] },
  ...
  62: { prices: {   pluginboutique: '$199.00', reverb: "$199.00", zzounds: '$199.00'     ,
      gear4music: "£119.00"} , oos: ['andertons', 'musicstore'] },
  63: { prices: {   pluginboutique: '$199.00', reverb: "$199.00", zzounds: '$199.00'     ,
      gear4music: "£145.00"} , oos: ['andertons', 'musicstore'] },
  64: { prices: {  reverb: "$1,875.65", amazon: '$1,875.65'  ,
      gear4music: "£1,799.00"} , oos: ['zzounds', 'andertons', 'musicstore'] },
  65: { prices: {  reverb: "$862.39",amazon: '$862.39', zzounds: '$879.99', andertons: '£749.00'  ,
      gear4music: "£739.00", musicstore: "€2,399.00" } },
  66: { prices: {  reverb: "$849.99", amazon: '$849.99'  ,
      gear4music: "£859.00"} , oos: ['zzounds', 'andertons'] , musicstore: '€755.50'},
  67: { prices: {  reverb: "$849.99", amazon: '$849.99'  ,
      gear4music: "£799.00"} , oos: ['zzounds', 'andertons'] , musicstore: '€948.70'},
  68: { prices: {  reverb: "$204.99",amazon: '$204.99', andertons: '£179.00'  ,
      gear4music: "£172.00"} , oos: ['zzounds', 'musicstore'] },
  71: { prices: {  reverb: "$789.99",amazon: '$789.99',  zzounds: '$789.99', andertons: '£749.00'  ,
      gear4music: "£749.00", musicstore: '€761.60' } },
  72: { prices: {  reverb: "$349.99",amazon: '$349.99', zzounds: '$299.99'  , andertons: '£259.00'  ,
      gear4music: "£259.00"} , oos: ['musicstore']},
  ...
  93: { prices: {  reverb: "$2499.00",amazon: '$2499.00',  zzounds: '$1,099.00'  ,
      gear4music: "£845.00"} , oos: ['andertons'] , musicstore: "€675.00" },
  95: { prices: {  reverb: "$749.00",amazon: '$749.00', zzounds: '$749.00'  , andertons: '£518.00'  ,
      gear4music: "£518.00", musicstore: "€80.00" } },
  96: { prices: {  reverb: "$99.00",amazon: '$99.00', zzounds: '$99.99', andertons: '£109.99'  ,
      gear4music: "£110.00"} , oos: ['musicstore']},
  97: { prices: {  reverb: "$186.20",amazon: '$186.20', zzounds: '$197.99', andertons: '£174.99'  ,
      gear4music: "£166.00"} , oos: ['musicstore']},
  98: { prices: {  reverb: "$103.50",amazon: '$103.50', zzounds: '$109.99', andertons: '£89.99'  ,
      gear4music: "£84.20"} , oos: ['musicstore']},
  99: { prices: {  reverb: "$99.99",amazon: '$99.99', zzounds: '$99.99', andertons: '£99.99'  ,
      gear4music: "£99.00", musicstore: "€69.00" } },
  100: { prices: {  reverb: "$129.00",amazon: '$129.00', andertons: '£95.00'  ,
      gear4music: "£95.00"} , oos: ['zzounds', 'musicstore'] },
  101: { prices: {  reverb: "$83.50",amazon: '$83.50', andertons: '£69.99'  ,
      gear4music: "£67.90"} , oos: ['zzounds', 'musicstore'] },
  102: { prices: {  reverb: "$229.00",amazon: '$229.00', andertons: '£299.00'  ,
      gear4music: "£239.00"} , oos: ['zzounds', 'musicstore'] },
  103: { prices: {  reverb: "$329.99",amazon: '$329.99', zzounds: '$359.99', andertons: '£269.00'  ,
      gear4music: "£180.00", musicstore: "€319.00" } },
  104: { prices: {  reverb: "$3,499.99",amazon: '$3,499.99', andertons: '£3,599.00', musicstore: "€3,399.00"  ,
      gear4music: "OOS"} , oos: ['zzounds'] },
  ...
  106: { prices: {  reverb: "$899.99",amazon: '$899.99', zzounds: '$899.99', andertons: '£845.00'  ,
      gear4music: "£862.00", musicstore: "€549.00" } },
  108: { prices: {  reverb: "$909.99",amazon: '$909.99', zzounds: '$909.99'  ,
      gear4music: "£659.00"} , oos: ['andertons', 'musicstore'] },
  ...
  110: { prices: {  reverb: "$749.00",amazon: '$749.00', andertons: '£599.00'  ,
      gear4music: "£529.00", musicstore: "€3,212.00" } },
  ...
  178: { prices: {  reverb: "$1,199.00",amazon: '$1,199.00'  ,
      gear4music: "£1,079.00"} , oos: ['andertons', 'musicstore'] },
  180: { prices: {  reverb: "$3,999.99",amazon: '$3,999.99'  ,
      gear4music: "£2,954.00"} , oos: ['andertons', 'musicstore'] },
  181: { prices: {  reverb: "$4,199.00",amazon: '$4,199.00'  ,
      gear4music: "£3,120.00"} , oos: ['andertons', 'musicstore'] },
  ...
  112: { prices: { amazon: '$165.00' , reverb: "$165.00", zzounds: '$179.00'  ,
      gear4music: "£192.25"} , oos: ['andertons', 'musicstore'] },
  113: { prices: { amazon: '$599.00', andertons: '£549.00' , reverb: "$599.00", zzounds: '$599.00'  } , oos: ['musicstore', 'gear4music']},
  114: { prices: { amazon: '$579.99' , andertons: '£479.00', zzounds: '$579.99'  } , oos: ['reverb', 'musicstore', 'gear4music'] },
  115: { prices: { andertons: '£299.00'  ,
      gear4music: "£245.00", amazon: '$399.00'} , oos: ['reverb'] },
  ...
  119: { prices: {   pluginboutique: '$30.00', reverb: "$30.00"     ,
      gear4music: "£300.50"} , oos: ['zzounds', 'musicstore'] },
  120: { prices: {  pluginboutique: '$99.00', reverb: "$99.00", zzounds: '$249.00'  ,
      gear4music: "£74.99", amazon: '$119.00'} , oos: ['andertons', 'musicstore'] },
  121: { prices: {   pluginboutique: '$999.00', andertons: '£579.00', reverb: "$999.00"     ,
      gear4music: "£899.00"} , oos: ['musicstore']},
  122: { prices: {   pluginboutique: '$1399.00', reverb: "$1399.00"     ,
      gear4music: "£1,299.00"} , oos: ['andertons', 'musicstore'] },
  ...
  125: { prices: {  reverb: "$719.99", amazon: '$719.99'  ,
      gear4music: "£699.00"} , oos: ['zzounds', 'andertons', 'musicstore'] },
  ...
  128: { prices: {  reverb: "$469.99",amazon: '$469.99', zzounds: '$469.99'  , andertons: '£345.00'  ,
      gear4music: "£345.00"} , oos: ['musicstore']},
  ...
  165: { prices: {  zzounds: '$649.00'  ,
      gear4music: "£579.00", amazon: '$599.00'} , oos: ['andertons'] },
  166: { prices: {  andertons: '£319.00'  ,
      gear4music: "£349.00", amazon: '$399.00'} , oos: ['zzounds', 'musicstore'] },
  167: { prices: {  reverb: "$54.95", amazon: '$54.95', zzounds: '$65.95'  ,
      gear4music: "£44.99"} , oos: ['andertons', 'musicstore'] },
  170: { oos: ['gear4music'] },
  ...
  188: { prices: {  reverb: "$1699.00",amazon: '$1699.00',  zzounds: '$1,699.00', andertons: '£1,399.00'  ,
      gear4music: "£1,399.00"} , oos: ['musicstore']},
  189: { prices: {  reverb: "$2,149.99", amazon: '$2,149.99', zzounds: '$2,149.99', andertons: '£1,099.00'  } ,
        gear4music: '£1,649', oos: ['musicstore']},
  190: { prices: {  reverb: "$2749.00",amazon: '$2749.00', zzounds: '$2,749.00', andertons: '£1,799.00'  } , oos: ['andertons', 'musicstore'] ,
        gear4music: '£1,891'},
  ...
  201: { prices: {  reverb: "$83.90", amazon: '$83.90', andertons: '£58.00'  ,
      gear4music: "£70.00"} , oos: ['zzounds', 'musicstore'] },
  202: { prices: {  reverb: "$599.99",amazon: '$599.99',  zzounds: '$599.99', andertons: '£479.00'  ,
      gear4music: "£549.00"} , oos: ['musicstore']},
  203: { prices: {  reverb: "$228.50",amazon: '$228.50',  zzounds: '$229.99'  ,
      gear4music: "£219.00"} , oos: ['andertons', 'musicstore'] },
  ...
  213: { prices: {  reverb: "$199.00", amazon: '$199.00', zzounds: '$199.00', andertons: '£179.00'  ,
      gear4music: "£185.50", musicstore: "€379.00" } },
  ...
  218: { prices: {  reverb: "$669.99", amazon: '$669.99', zzounds: '$589.99', andertons: '£463.00'  ,
      gear4music: "£488.00", musicstore: "€569.00" } },
  ...
  225: { prices: {  reverb: "$549.00",amazon: '$549.00', zzounds: '$549.00', andertons: '£429.00'  ,
      gear4music: "£452.00", musicstore: "€549.00" } },
  ...
  238: { prices: {   pluginboutique: '$99.00', reverb: "$99.00"     ,
      gear4music: "£39.00", amazon: '$99.00'} , oos: ['andertons', 'musicstore'] },
  239: { prices: {  reverb: "$499.00",amazon: '$499.00', zzounds: '$488.00', andertons: '£390.00'  } ,
        gear4music: '£899', oos: ['musicstore']},
  ...
  267: { prices: {  reverb: "$989.00",amazon: '$989.00',  zzounds: '$989.00', andertons: '£859.00'  } ,
        gear4music: '£1,399', oos: ['musicstore']},
  269: { prices: {  reverb: "$989.00",amazon: '$989.00',  zzounds: '$999.00', andertons: '£866.00'  } ,
        gear4music: '£813', oos: ['musicstore']},
  271: { prices: {  reverb: "$599.00",amazon: '$599.00',  andertons: '£449.00'  } , oos: ['zzounds', 'musicstore'] ,
        gear4music: '£519'},
...
273: { prices: { reverb: "$879.99", amazon: '$879.99', andertons: '£699.00', gear4music: "£706.00", musicstore: "€739.00" } },
  ...
  301: { prices: {  reverb: "$599.99",amazon: '$599.99',  zzounds: '$599.99', andertons: '£566.00'  ,
      gear4music: "£629.00"} , oos: ['musicstore']},
  ...
  304: { prices: {  reverb: "$109.99", andertons: '£449.00'  ,
      gear4music: "£249.99", amazon: '$599.00'} , oos: ['zzounds'] , musicstore: '€298'},
  ...
  307: { prices: {  reverb: "$349.00",amazon: '$349.00',  zzounds: '$349.00', andertons: '£276.99'  ,
      gear4music: "£295.00", musicstore: '€298' } },
  ...
  310: { prices: {  reverb: "$319.99",amazon: '$319.99',  zzounds: '$319.99'  } , oos: ['andertons'] ,
        gear4music: '£229'},
  311: { prices: {  reverb: "$499.99",amazon: '$499.99',  zzounds: '$499.99'  } , oos: ['andertons', 'musicstore'] ,
        gear4music: '£379'},
  ...
  340: { prices: {  reverb: "$485.00",amazon: '$485.00', zzounds: '$485.00'  , andertons: '£449.00'  ,
      gear4music: "£491.00", musicstore: "€569.00" } },
  ...
  343: { prices: {  reverb: "$269.00",amazon: '$269.00', zzounds: '$269.00'  ,
      gear4music: "£485.00"} , oos: ['andertons', 'musicstore'] },
...
(function(){
  function doSwap(){
    document.querySelectorAll('.guide-product-card-stores').forEach(function(c){
    ...
    if(ml){
      ...
      var amazonRow='<a data-store="amazon" href="'+aUrl+'" target="_blank" rel="noopener noreferrer sponsored" style="width:100%;box-sizing:border-box;flex:none;min-height:40px;display:flex;align-items:center;gap:8px;padding:0 16px;height:40px;border-radius:12px;background:#333333;transition:transform .18s ease,background .18s ease,box-shadow .18s ease;color:#ffffff;text-decoration:none;font-size:15px;font-weight:800;border:none">'+globe+'<span style="font-family:Arial,Helvetica,sans-serif;font-weight:800;color:#fff"><span style="position:relative;display:inline-block">Amaz<svg viewBox="86 114 320 72" preserveAspectRatio="none" style="position:absolute;left:17.8%;top:100%;height:7px;width:calc(80% - 1px);margin-top:-5px"><path fill="#FF9900" d="m 374.00642,142.18404 c -34.99948,25.79739 -85.72909,39.56123 -129.40634,39.56123 -61.24255,0 -116.37656,-22.65135 -158.08757,-60.32496 -3.2771,-2.96252 -0.34083,-6.9999 3.59171,-4.69283 45.01431,26.19064 100.67269,41.94697 158.16623,41.94697 38.774689,0 81.4295,-8.02237 120.6499,-24.67006 5.92501,-2.51683 10.87999,3.88009 5.08607,8.17965"/><path fill="#FF9900" d="m 388.55678,125.53635 c -4.45688,-5.71527 -29.57261,-2.70033 -40.84585,-1.36327 -3.43442,0.41947 -3.95874,-2.56925 -0.86517,-4.71905 20.00346,-14.07844 52.82696,-10.01483 56.65462,-5.2958 3.82764,4.74526 -0.99624,37.64741 -19.79373,53.35128 -2.88385,2.41195 -5.63662,1.12734 -4.35198,-2.07113 4.2209,-10.53917 13.68519,-34.16054 9.20211,-39.90203"/></svg></span>on</span><span style="color:#a8a8a8;font-size:12px;font-weight:600;margin-left:4px">(Prime Delivery)</span>'+azPriceHtml+'</a>';
