...
const TEST_SHOP_BTN = {
  ...
  22: {prices:{amazon:"$1175.00",andertons:"£959.00",gear4music:"£812.00",musicstore:"€949.00"}},
  ...
  39: {prices:{amazon:"$49.00",andertons:"£42.00",gear4music:"£53.50",musicstore:"€168.00"}},
  42: {prices:{amazon:"$1299.99",zzounds:"$1,299.99",andertons:"£1,052.00",gear4music:"£1,039.00",musicstore:"€1,099.00"}},
  ...
  57: {prices:{amazon:"$139.80",andertons:"£134.00",gear4music:"£125.00",musicstore:"€121.43"}},
  58: {prices:{amazon:"$94.99",zzounds:"$108.99",andertons:"£54.00",gear4music:"£54.40",musicstore:"€888.00"}},
  59: {prices:{amazon:"$165.99",andertons:"£77.00",gear4music:"£77.40",musicstore:"€539.00"}},
  ...
  62: {prices:{pluginboutique:"$199.00",zzounds:"$199.00",gear4music:"£119.00",musicstore:"€675.00",andertons:"£126.00"}},
  63: {prices:{pluginboutique:"$199.00",zzounds:"$199.00",gear4music:"£145.00",musicstore:"€148.00",andertons:"£139.00"}},
  64: {prices:{amazon:"$1,875.65",gear4music:"£1,799.00",musicstore:"€2,229.00"},oos:["andertons"]},
  65: {prices:{amazon:"$862.39",zzounds:"$879.99",andertons:"£749.00",gear4music:"£739.00",musicstore:"€844.00"}},
  66: {prices:{amazon:"$849.99",gear4music:"£859.00",musicstore:"€1,090.00"},oos:["andertons"]},
  67: {prices:{amazon:"$849.99",gear4music:"£799.00",musicstore:"€110.00",andertons:"£729.00"}},
  ...
  91: {prices:{amazon:"$659.00",zzounds:"$659.00",andertons:"£569.00",gear4music:"£589.00",musicstore:"€539.00"}},
  92: {prices:{amazon:"$849.00"},urls:{gear4music:"https://www.gear4music.com/PA-DJ-and-Lighting/Sennheiser-EW-100-G4-Wireless-Microphone-System-with-935-S-E-Band/2BBJ",musicstore:"€99.00"},oos:["andertons"]},
  93: {prices:{amazon:"$2499.00",zzounds:"$1,099.00",gear4music:"£845.00",musicstore:"€868.00"},oos:["andertons"]},
  ...
  98: {prices:{amazon:"$103.50",zzounds:"$109.99",andertons:"£89.99",gear4music:"£84.20",musicstore:"€884.00"}},
  99: {prices:{amazon:"$99.99",zzounds:"$99.99",andertons:"£99.99",gear4music:"£99.00",musicstore:"€169.00"}},
  100: {prices:{amazon:"$129.00",andertons:"£95.00",gear4music:"£95.00",musicstore:"€110.00"}},
  101: {prices:{amazon:"$83.50",andertons:"£69.99",gear4music:"£67.90",musicstore:"€66.00"}},
  102: {prices:{amazon:"$229.00",andertons:"£299.00",gear4music:"£239.00",musicstore:"€139.00"}},
  103: {prices:{amazon:"$329.99",zzounds:"$359.99",andertons:"£269.00",gear4music:"£180.00",musicstore:"€329.00"}},
  104: {prices:{amazon:"$3,499.99",andertons:"£3,599.00",musicstore:"€3,499.00"}},
  105: {prices:{amazon:"$549.00",zzounds:"$549.00",andertons:"£436.00",gear4music:"£469.00",musicstore:"€2,990.00"}},
...
{prices:{amazon:"$749.00",andertons:"£599.00",gear4music:"£529.00",musicstore:"€503.36"}},
  ...
  114: {prices:{gear4music:"£479.00",amazon:"$579.99",andertons:"£479.00",zzounds:"$579.99",musicstore:"€2,099.00",pluginboutique:"$579.99"}},
  115: {prices:{andertons:"£299.00",gear4music:"£245.00",amazon:"$399.00",pluginboutique:"$299.00"}},
  116: {prices:{amazon:"$129.00",andertons:"£112.00",gear4music:"£115.00",musicstore:"€155.00"}},
  ...
  119: {prices:{pluginboutique:"$30.00",gear4music:"£300.50",musicstore:"€83.19"}},
  120: {prices:{pluginboutique:"$99.00",zzounds:"$249.00",gear4music:"£74.99",amazon:"$119.00",musicstore:"€335.29",andertons:"£535.00"}},
  121: {prices:{pluginboutique:"$999.00",andertons:"£579.00",gear4music:"£899.00",musicstore:"€2,599.00"}},
  ...
  125: {prices:{amazon:"$719.99",gear4music:"£699.00",musicstore:"€777.00",andertons:"£799.00"}},
  ...
  138: {prices:{amazon:"$1,398.00",andertons:"£991.00",gear4music:"£1,037.00",musicstore:"€1,298.00"}},
  139: {prices:{gear4music:"£3050.00",amazon:"$3,999.00",andertons:"£2,599.00",musicstore:"€2,990.00"}},
  140: {prices:{amazon:"$749.99",zzounds:"$769.99",andertons:"£649.00",gear4music:"£549.00",musicstore:"€599.00"}},
  141: {prices:{amazon:"$649.99",andertons:"£589.00",gear4music:"£584.00",musicstore:"€619.00",zzounds:"$699.99"}},
  ...
  145: {prices:{amazon:"$509.00",andertons:"£315.00",gear4music:"£315.00",musicstore:"€369.00"}},
  ...
  148: {prices:{gear4music:"£2009.00",amazon:"$2,499.00",andertons:"£1,452.00",musicstore:"€2,099.00"}},
  149: {prices:{gear4music:"£504.00",amazon:"$675.00",zzounds:"$573.74",andertons:"£599.00",musicstore:"€599.00"}},
  150: {prices:{gear4music:"£188.50",amazon:"$268.00",andertons:"£169.00",musicstore:"€195.00"}},
  151: {prices:{gear4music:"£407.00",amazon:"$374.99",musicstore:"€335.29"},oos:["andertons"]},
  ...
  154: {prices:{amazon:"$390.99",andertons:"£394.00",gear4music:"£394.00",musicstore:"€366.47"}},
  ...
  157: {prices:{amazon:"$529.99",andertons:"£399.00",gear4music:"£389.00",musicstore:"€354.12"}},
  ...
  162: {prices:{amazon:"$350.00",andertons:"£799.00",gear4music:"£599.00"},oos:["musicstore"]},
  ...
  166: {prices:{andertons:"£319.00",gear4music:"£349.00",amazon:"$399.00",musicstore:"€293.28"}},
  167: {prices:{amazon:"$54.95",zzounds:"$65.95",gear4music:"£44.99",musicstore:"€1,799.00"},oos:["andertons"]},
  ...
  174: {prices:{gear4music:"£3499.00",amazon:"$3473.73",zzounds:"$3,499.99",andertons:"£2,899.00",musicstore:"€219.00"}},
  175: {prices:{gear4music:"£4337.00",amazon:"$4399.99",zzounds:"$3,499.99",andertons:"£3,899.00",musicstore:"€369.00"}},
  176: {prices:{amazon:"$3299.00",zzounds:"$3,499.00",andertons:"£4,999.00",gear4music:"£2,850.00",musicstore:"€3,149.00"}},
  ...
  185: {prices:{amazon:"$2299.99",zzounds:"$2,299.99",andertons:"£2,049.00",gear4music:"£2,079.00",musicstore:"€1,998.00"}},
  ...
  201: {prices:{amazon:"$83.90",andertons:"£58.00",gear4music:"£70.00",musicstore:"€66.00"}},
  ...
  206: {prices:{amazon:"$1599.00",zzounds:"$1,599.00",andertons:"£1,399.00",gear4music:"£478.00",musicstore:"€1,799.00"}},
  ...
  209: {prices:{amazon:"$1,399.00",andertons:"£879.00"},urls:{gear4music:"https://www.gear4music.com/Recording-and-Computers/Austrian-Audio-OC818-Studio-Set-Black/4PIK",musicstore:"€1,199.00"}},
  ...
  215: {prices:{gear4music:"£532.00",amazon:"$660.00",andertons:"£405.00",musicstore:"€461.34"}},
  216: {prices:{gear4music:"£1,016.00",amazon:"$1,699.00",andertons:"£899.00",musicstore:"€1,091.60"}},
  ...
  231: {prices:{amazon:"$259.00",andertons:"£259.00",gear4music:"£236.50",musicstore:"€335.29"}},
  ...
  267: {prices:{amazon:"$989.00",zzounds:"$989.00",andertons:"£859.00",gear4music:"£1,399",musicstore:"€159.00"}},
  ...
  271: {prices:{amazon:"$599.00",andertons:"£449.00",gear4music:"£519",musicstore:"€461.34"}},
  ...
  275: {prices:{gear4music:"£349.00",amazon:"$329.99",musicstore:"€335.29"},oos:["andertons"]},
  ...
  303: {prices:{gear4music:"£293.50",amazon:"$395.00",andertons:"£288.00",musicstore:"€438.66"}},
  304: {prices:{andertons:"£449.00",gear4music:"£249.99",amazon:"$599.00",musicstore:"€250.42"}},
  ...
  326: {prices:{amazon:"$499.00",zzounds:"$499.00",andertons:"£399.00",gear4music:"$499.00"}},
  ...
  330: {prices:{gear4music:"£16.80",amazon:"$20.99",andertons:"£16.00",musicstore:"€15.97"}},
  ...
  338: {prices:{andertons:"£1,019.00",musicstore:"€587.39"},oos:["gear4music"]},
  ...
  354: {prices:{gear4music:"£499.00",andertons:"£379.00",amazon:"$599.00",musicstore:"€419.33"}},
  355: {prices:{gear4music:"£339.00",andertons:"£399.00",musicstore:"€335.29"},oos:["amazon"]},
  ...
  360: {prices:{amazon:"$1499.00",zzounds:"$1,499.00",musicstore:"€1,368.90"},oos:["andertons"]},
  ...
  372: {prices:{amazon:"$795.00",andertons:"£517.00",gear4music:"£540.00",musicstore:"€453.78"}},
  ...
  385: {na:["andertons","gear4music","musicstore"],prices:{pluginboutique:"$80.00",amazon:"$80.00"},urls:{pluginboutique:"https://www.pluginboutique.com/product/3-Studio-Tools/72-Utility/17627-MIXVAULT",amazon:"https://www.amazon.com/Mastering-Mix-MIXROOM-Plugin/dp/B09VH5YZ1D"}},
  ...
  396: {prices:{amazon:"$419.00",gear4music:"£289.00",andertons:"£266.00",musicstore:"€298.00"}},
  ...
  399: {prices:{musicstore:"€318.49"},oos:["amazon"]},
  ...
  402: {prices:{amazon:"$1,999.00",gear4music:"£1,447.00",andertons:"£1,234.00",musicstore:"€1,306.72"}},
  403: {prices:{gear4music:"£3,139.00",amazon:"$2,499",andertons:"£2,599.00",musicstore:"€2,501.68"}},
  ...
  423: {prices:{amazon:"$349.00",gear4music:"£255.00",musicstore:"€285.00"}},
  424: {prices:{amazon:"$599.00",gear4music:"£559.00",musicstore:"€458.00"}},
  425: {prices:{amazon:"$179.00",musicstore:"€335.29"}},
...
<body style="margin:0;padding:0;">
  ...
  <main id="mainContent">
    ...
    <div class="guide-detail">
      ...
      ${guide.comparison ? (function(){ var comp = guide.comparison; var headers = comp.headers || []; var colMin = 0; headers.forEach(function(h){ if(h.length>colMin) colMin=h.length; }); colMin += 2; var thHtml = headers.map(function(h,i){ var hn = isEs && comp['header'+(i+1)+'_es'] ? comp['header'+(i+1)+'_es'] : h; return '<th>'+hn+'</th>'; }).join(''); var trs = comp.rows.filter(function(r){ var l=(r.label||'').trim().toLowerCase(); if(l==='rating') return false; return !/(price|precio|msrp|cost)/.test(l); }).map(function(r){ var tds = '<td class="label">'+(isEs?r.label_es:r.label)+'</td>'; var valKeys = ['val','val2','val3','val4','val5']; valKeys.forEach(function(k,i){ var esK = k+'_es'; var v = isEs && r[esK] ? r[esK] : r[k]; tds += '<td class="val">'+(v||'')+'</td>'; }); return '<tr>'+tds+'</tr>'; }).join(''); return '<div class="guide-comp-wrap"><h2 class="guide-comp-title">'+(isEs?'¿Cómo se Comparan?':'How Do They Compare?')+'</h2>'+guideCompControls(isEs,'guide-comp-controls-top')+'<div class="guide-comp-scroll-wrap"><div class="guide-comp-scroll"><table class="guide-comp-table" style="--guide-col-min:'+colMin+'ch"><thead><tr><th></th>'+thHtml+'</tr></thead><tbody>'+trs+'</tbody></table></div>'+guideCompControls(isEs)+'</div></div>'; })() : ''}
...
(function(){
  function doSwap(){
    ...
    if(!zRow){
      ...
      if(!ml)return;
      var zHref='https://www.zzounds.com/item--'+encodeURIComponent((document.querySelector('.guide-product-card-title')||{}).textContent||'').replace(/%20/g,'+')+'?tag=topmusicg-20';
