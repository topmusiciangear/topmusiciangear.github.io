...
const TEST_SHOP_BTN = {
  ...
  92: { prices: { amazon: "$849.00" }, oos: ["zzounds", "andertons", "musicstore"] },
  ...
  113: { prices: { amazon: "$599.00", andertons: "£549.00", reverb: "$599.00", zzounds: "$599.00" }, oos: ["musicstore", "pluginboutique"] },
  114: { prices: { amazon: "$579.99", andertons: "£479.00", zzounds: "$579.99" }, oos: ["reverb", "musicstore", "pluginboutique"] },
  ...
  118: { prices: { pluginboutique: "$1999.00", reverb: "$1999.00" }, oos: ["musicstore"] },
  ...
  123: { prices: { pluginboutique: "$1249.00", andertons: "£1,124.00", reverb: "$1249.00", zzounds: "$1,249.00" }, oos: ["musicstore"] },
  124: { prices: { reverb: "$879.99", amazon: "$879.99", zzounds: "$879.99", andertons: "£919.00" }, oos: ["musicstore"] },
  125: { prices: { reverb: "$719.99", amazon: "$719.99", gear4music: "£699.00" }, oos: ["zzounds", "andertons", "musicstore"] },
  126: { prices: { reverb: "$1,839.99", amazon: "$1,839.99", zzounds: "$1,839.99", andertons: "£1,599.00" }, oos: ["musicstore"] },
  ...
  130: { prices: { reverb: "$149.99", amazon: "$149.99", zzounds: "$149.99", andertons: "£129.00", musicstore: "€179.00" }},
  ...
  139: { prices: { reverb: "$3,999.00", amazon: "$3,999.00", andertons: "£2,599.00" }, oos: ["zzounds", "musicstore"] },
  ...
  144: { prices: { reverb: "$299.99", amazon: "$299.99", andertons: "£249.00" }, oos: ["zzounds", "musicstore"] },
  ...
  148: { prices: { reverb: "$2,499.00", amazon: "$2,499.00", andertons: "£1,452.00" }, oos: ["zzounds", "musicstore"] },
  149: { prices: { reverb: "$675.00", amazon: "$675.00", zzounds: "$573.74", andertons: "£599.00" }, oos: ["musicstore"] },
  150: { prices: { reverb: "$268.00", amazon: "$268.00", andertons: "£169.00" }, oos: ["zzounds", "musicstore"] },
  151: { prices: { reverb: "$374.99", amazon: "$374.99" }, oos: ["zzounds", "andertons", "musicstore"] },
  ...
  156: { prices: { reverb: "$1,739.99", amazon: "$1,739.99", zzounds: "$1,939.99", andertons: "£1,799.00", musicstore: "€2,199.00" }},
  ...
  163: { prices: { zzounds: "$599.00", andertons: "£349.00" }, oos: ["musicstore"] },
  ...
  170: { oos: ["musicstore"] },
  173: { prices: { reverb: "$23.00", amazon: "$23.00" }, oos: ["andertons", "musicstore"] },
  174: { prices: { reverb: "$3473.73", amazon: "$3473.73", zzounds: "$3,499.99", andertons: "£2,899.00" }, oos: ["musicstore"] },
  175: { prices: { reverb: "$4399.99", amazon: "$4399.99", zzounds: "$3,499.99", andertons: "£3,899.00" }, oos: ["musicstore"] },
  ...
  186: { prices: { reverb: "$2749.00", amazon: "$2749.00", zzounds: "$2,549.00", andertons: "£2,599.00" }, oos: ["musicstore"] },
  187: { prices: { reverb: "$3499.00", amazon: "$3499.00", zzounds: "$3,499.00", andertons: "£2,566.00", musicstore: "€3,190.00" }},
  ...
  191: { prices: { reverb: "$479.00", amazon: "$479.00", zzounds: "$399.99", andertons: "£339.00" }, oos: ["musicstore"] },
  192: { prices: { reverb: "$424.99", amazon: "$424.99", zzounds: "$424.99", andertons: "£451.00", gear4music: "£263.00", musicstore: "€515.00" } },
  193: { prices: { reverb: "$499.99", amazon: "$499.99", zzounds: "$499.99", andertons: "£349.00" }, oos: ["musicstore"] },
  194: { prices: { reverb: "$199.00", amazon: "$199.00", zzounds: "$199.00", andertons: "£272.00", gear4music: "£273.50", musicstore: "€309.00" } },
  195: { prices: { reverb: "$119.99", amazon: "$119.99" }, oos: ["andertons", "musicstore"] },
  ...
  204: { prices: { reverb: "$349.99", amazon: "$349.99", zzounds: "$384.99", andertons: "£309.00" }, oos: ["musicstore"] },
  205: { prices: { reverb: "$449.00", amazon: "$449.00", zzounds: "$499.00", andertons: "£439.00" }, oos: ["musicstore"] },
  ...
  209: { prices: { reverb: "$1,399.00", amazon: "$1,399.00", andertons: "£879.00" }, oos: ["zzounds", "musicstore"] },
  210: { prices: { reverb: "$219.00", amazon: "$219.00", zzounds: "$219.00", andertons: "£149.00", gear4music: "£149.50", musicstore: "€152.00" } },
  211: { prices: { reverb: "$399.00", amazon: "$399.00", zzounds: "$499.99", andertons: "£372.00", musicstore: "€549.00" }},
  ...
  214: { prices: { reverb: "$429.00", amazon: "$429.00", zzounds: "$429.00", andertons: "£295.00" }, oos: ["musicstore"] },
  215: { prices: { reverb: "$660.00", amazon: "$660.00", andertons: "£405.00" }, oos: ["zzounds", "musicstore"] },
  216: { prices: { reverb: "$1,699.00", amazon: "$1,699.00", andertons: "£899.00" }, oos: ["zzounds", "musicstore"] },
  217: { prices: { reverb: "$949.00", amazon: "$949.00", zzounds: "$949.00", andertons: "£787.00", musicstore: "€949.00" }},
  218: { prices: { reverb: "$669.99", amazon: "$669.99", zzounds: "$589.99", andertons: "£463.00", gear4music: "£488.00", musicstore: "€569.00" } },
  219: { prices: { reverb: "$696.99", amazon: "$696.99", zzounds: "$696.99", andertons: "£555.00", musicstore: "€649.00" }},
  220: { prices: { reverb: "$399.99", zzounds: "$949.00", amazon: "$949.00" }, oos: ["andertons", "musicstore"] },
  221: { prices: { reverb: "$2,100.00", amazon: "$2,100.00" }, oos: ["andertons", "musicstore"] },
  222: { prices: { reverb: "$9,985.00" } },
  223: { prices: { reverb: "$3,499.00", amazon: "$3,499.00" }, oos: ["andertons", "musicstore"] },
  224: { prices: { reverb: "$2,299.00", amazon: "$2,299.00", zzounds: "$2,299.00" }, oos: ["andertons", "musicstore"] },
  ...
  227: { prices: { reverb: "$199.95", amazon: "$199.95", zzounds: "$199.95", andertons: "£149.00" }, oos: ["musicstore"] },
  ...
  230: { prices: { reverb: "$131.60", amazon: "$131.60", zzounds: "$139.00", andertons: "£99.00", musicstore: "€149.00" }},
  ...
  236: { prices: { reverb: "$1,349.00", amazon: "$1,349.00", zzounds: "$1,499.00", andertons: "£1,149.00" }, oos: ["musicstore"] },
  237: { prices: { reverb: "$1,739.99", amazon: "$1,739.99", andertons: "£1,452.00" }, oos: ["musicstore"] },
  ...
  240: { prices: { amazon: "$499.99", zzounds: "$459.99", andertons: "£379.00" }, oos: ["musicstore"] },
  243: { prices: { reverb: "$159.99", amazon: "$159.99" }, oos: ["andertons", "musicstore"] },
  244: { prices: { reverb: "$249.00", amazon: "$249.00", zzounds: "$229.00", andertons: "£251.00" }, oos: ["musicstore"] },
  246: { prices: { reverb: "$169.99", amazon: "$169.99" }, oos: ["andertons"] },
  247: { prices: { reverb: "$799.99", amazon: "$799.99", zzounds: "$799.99", andertons: "£521.00" }, oos: ["musicstore"] },
  ...
  250: { prices: { reverb: "$260.00", amazon: "$260.00", zzounds: "$260.00", andertons: "£258.00" }, oos: ["musicstore"] },
  251: { prices: { amazon: "$76.00" }, oos: ["andertons"] },
  252: { prices: { reverb: "$209.00", amazon: "$209.00", zzounds: "$193.58", andertons: "£173.00", musicstore: "€239.00" }},
  ...
  257: { prices: { reverb: "$399.00", amazon: "$399.00", zzounds: "$399.00", andertons: "£329.00" }, oos: ["musicstore"] },
  258: { prices: { reverb: "$249.99", amazon: "$249.99", zzounds: "$199.99", andertons: "£249.00" }, oos: ["musicstore"] },
  259: { prices: { reverb: "$499.99", amazon: "$499.99", zzounds: "$599.99", andertons: "£399.00" }, oos: ["musicstore"] },
  ...
  266: { prices: { reverb: "$1,749.00", amazon: "$1,749.00", zzounds: "$1,749.00", andertons: "£1,180.00" }, oos: ["musicstore"] },
  ...
  274: { prices: { reverb: "$239.99", amazon: "$239.99" }, oos: ["andertons", "musicstore"] },
  275: { prices: { reverb: "$329.99", amazon: "$329.99" }, oos: ["zzounds", "andertons", "musicstore"] },
  276: { prices: { reverb: "$69.99", amazon: "$69.99", zzounds: "$99.99", musicstore: "€89.00" }, oos: ["andertons"] },
  ...
  294: { prices: { reverb: "$279.00", amazon: "$279.00", zzounds: "$349.00" }, oos: ["andertons", "musicstore"] },
  ...
  302: { prices: { reverb: "$599.99", amazon: "$599.99", zzounds: "$299.99", andertons: "£249.00" }, oos: ["musicstore"] },
  ...
  305: { prices: { reverb: "$593.75", amazon: "$593.75", zzounds: "$599.00", andertons: "£499.00", musicstore: "€394.10" }},
  306: { prices: { reverb: "$289.99", amazon: "$289.99", zzounds: "$349.99", andertons: "£260.00" }, oos: ["musicstore"] },
  307: { prices: { reverb: "$349.00", amazon: "$349.00", zzounds: "$349.00", andertons: "£276.99", gear4music: "£295.00", musicstore: "€298" } },
  308: { prices: { reverb: "$799.99", amazon: "$799.99", zzounds: "$799.99", andertons: "£609.00", musicstore: "€377.30" }},
  ...
  313: { prices: { reverb: "$249.99", amazon: "$249.99", zzounds: "$249.99", andertons: "£139.00" }, oos: ["musicstore"] },
  314: { prices: { reverb: "$419.99", amazon: "$419.99" }, oos: ["andertons", "musicstore"] },
  315: { prices: { reverb: "$259.99", amazon: "$259.99", zzounds: "$259.99", andertons: "£299.00" }, oos: ["musicstore"] },
  ...
  318: { prices: { reverb: "$2199.99", amazon: "$2199.99", zzounds: "$2,199.99", andertons: "£1,699.00" }, oos: ["musicstore"] },
  319: { prices: { reverb: "$2,275.00", amazon: "$2,275.00", zzounds: "$2,629.00", andertons: "£2,199.00" }, oos: ["musicstore"] },
  320: { prices: { reverb: "$649.95", amazon: "$649.95", zzounds: "$949.00", andertons: "£799.00" }, oos: ["musicstore"] },
  321: { prices: { reverb: "$467.00", amazon: "$467.00", zzounds: "$549.00", andertons: "£505.00", musicstore: "€522.00" }},
  322: { prices: { reverb: "$639.49", amazon: "$639.49", zzounds: "$749.00", andertons: "£598.00" }, oos: ["musicstore"] },
  ...
  325: { prices: { reverb: "$549.00", amazon: "$549.00", zzounds: "$549.00" }, oos: ["andertons", "musicstore"] },
  ...
  333: { prices: { reverb: "$459.99", amazon: "$459.99", andertons: "£249.00" }, oos: ["musicstore"] },
  334: { prices: { reverb: "$3,299.99", amazon: "$3,299.99", zzounds: "$3,299.99", andertons: "£1,499.00" }, oos: ["musicstore"] },
  335: { prices: { reverb: "$999.99", amazon: "$999.99", zzounds: "$744.95", andertons: "£649.00" }, oos: ["musicstore"] },
  336: { prices: { reverb: "$249.99", amazon: "$249.99", zzounds: "$249.99" }, oos: ["andertons", "musicstore"] },
  337: { prices: { reverb: "$1,999.00", amazon: "$1,999.00", zzounds: "$1,999.00", andertons: "£1,565.00" }, oos: ["musicstore"] },
  338: { prices: { reverb: "$359.99", andertons: "£1,019.00" }, oos: ["zzounds", "musicstore"] },
  339: { prices: { reverb: "$999.00", amazon: "$999.00", zzounds: "$999.00", andertons: "£949.00" }, oos: ["musicstore"] },
  ...
  346: { prices: { reverb: "$187.51", amazon: "$187.51", zzounds: "$219.00" }, oos: ["andertons", "musicstore"] },
  347: { prices: { zzounds: "$249.99", andertons: "£175.00", amazon: "$199.99" }, oos: ["musicstore"] },
  348: { prices: { zzounds: "$599.99", andertons: "£433.00", amazon: "$479.99" }, oos: ["musicstore"] },
  ...
  352: { prices: { reverb: "$189.00", amazon: "$189.00", zzounds: "$249.99", andertons: "£149.00" }, oos: ["musicstore"] },
  353: { prices: { reverb: "$529.99", amazon: "$529.99" }, oos: ["andertons", "musicstore"] },
  354: { prices: { reverb: "$799.99", andertons: "£379.00", amazon: "$599.00" }, oos: ["zzounds", "musicstore"] },
  355: { prices: { amazon: "na", andertons: "£399.00" }, oos: ["zzounds", "amazon", "musicstore"] },
  356: { prices: { reverb: "$199.99", amazon: "$199.99" }, oos: ["andertons", "musicstore"] },
  357: { prices: { reverb: "$599.99", amazon: "$599.99", andertons: "£499.00" }, oos: ["musicstore"] },
  358: { prices: { reverb: "$189.00", amazon: "$189.00", zzounds: "$189.00" }, oos: ["andertons", "musicstore"] },
  359: { prices: { reverb: "$94.99", amazon: "$94.99" }, oos: ["andertons", "musicstore"] },
  360: { prices: { reverb: "$1499.00", amazon: "$1499.00", zzounds: "$1,499.00" }, oos: ["andertons", "musicstore"] },
  361: { prices: { reverb: "$999.00", amazon: "$999.00", zzounds: "$999.99", andertons: "£829.00" }, oos: ["musicstore"] },
...
function shopButtonsTest(p, lang) {
  ...
  const rows = order.map(k => {
    ...
    if (oosList.indexOf(k) > -1 || (k === 'zzounds' && !prices[k] && stores[k])) {
