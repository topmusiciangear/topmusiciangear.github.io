...
'.hero-inner{font-family:-apple-system,BlinkMacSystemFont,"Segoe UI",sans-serif;max-width:960px;margin:0 auto;position:relative;z-index:1;display:flex;flex-direction:column;align-items:center;justify-content:center;min-height:calc(100vh - 64px)}',
    ...
    '.guide-detail .guide-detail-img{width:100%;border-radius:var(--radius-lg);overflow:hidden;margin-bottom:32px;border:1px solid var(--border);max-height:500px;background:#fff}.guide-detail .guide-detail-img img{width:100%;display:block;aspect-ratio:21/9;object-fit:cover;max-height:500px}',
    '.guide-product-card{contain:layout style;background:var(--bg-card);border:1px solid var(--border);border-radius:var(--radius-lg);overflow:hidden;display:flex;flex-direction:column}.guide-product-card-img{width:100%;aspect-ratio:4/3;overflow:hidden;background:#fff}.guide-product-card-img img{width:100%;height:100%;object-fit:cover}.guide-products-cards{display:grid;grid-template-columns:repeat(3,1fr);gap:24px}@media(max-width:900px){.guide-products-cards{grid-template-columns:repeat(2,1fr)}}@media(max-width:600px){.guide-products-cards{grid-template-columns:1fr;gap:16px}.guide-products-cards .guide-product-card-img{aspect-ratio:16/9}.guide-reviews{padding:16px}}.guide-products-grid{margin-top:48px;padding-top:32px;border-top:1px solid var(--border)}',
...
const TEST_SHOP_BTN = {
  ...
  20: {prices:{amazon:"$269.00",zzounds:"$269.00",gear4music:"£199.25",musicstore:"€266.00"},oos:["andertons"]},
  21: {prices:{amazon:"$899.99",zzounds:"$899.99",andertons:"£600.00",gear4music:"£600.00",musicstore:"€649.00"}},
  22: {prices:{amazon:"$1,175.00",andertons:"£959.00",gear4music:"£812.00",musicstore:"€949.00"},urls:{zzounds:"https://www.zzounds.com/a--925521/item--GEN8040BPM"},oos:["zzounds"]},
  ...
  28: {prices:{pluginboutique:"$299.00",andertons:"£269.00",gear4music:"£271.00",musicstore:"€295.00"}},
  ...
  39: {prices:{amazon:"$49.00",andertons:"£45.00",gear4music:"£53.50",musicstore:"€49.00"},urls:{zzounds:"https://www.zzounds.com/a--925521/item--ASTSWIFTSHIELD"},oos:["zzounds"]},
  ...
  57: {prices:{amazon:"$139.80",andertons:"£134.00",gear4music:"£125.00",musicstore:"€121.43"},urls:{zzounds:"https://www.zzounds.com/a--925521/item--AKGK371"},oos:["zzounds"]},
  58: {prices:{amazon:"$108.99",zzounds:"$108.99",andertons:"£54.00",gear4music:"£54.70",musicstore:"€52.00"}},
  59: {prices:{amazon:"$165.99",andertons:"£77.00",gear4music:"£77.40",musicstore:"€78.00"},urls:{zzounds:"https://www.zzounds.com/a--925521/item--KMS26754"},oos:["zzounds"]},
  ...
  68: {prices:{amazon:"$204.99",andertons:"£179.00",gear4music:"£179.00",musicstore:"€215.00",zzounds:"$229.99"}},
  ...
  91: {prices:{amazon:"$659.00",zzounds:"$599.00",andertons:"£589.00",gear4music:"£504.00",musicstore:"€635.00"}},
  92: {prices:{amazon:"$849.00",musicstore:"€769.00"},urls:{gear4music:"https://www.gear4music.com/PA-DJ-and-Lighting/Sennheiser-EW-100-G4-Wireless-Microphone-System-with-935-S-E-Band/2BBJ",zzounds:"https://www.zzounds.com/a--925521/item--SENEW100G4935S"},oos:["andertons","zzounds"]},
  ...
  100: {prices:{amazon:"$129.00",andertons:"£95.00",gear4music:"£95.00",musicstore:"€110.00"},urls:{zzounds:"https://www.zzounds.com/a--925521/item--TCEHALLOFFAME2"},oos:["zzounds"]},
  102: {prices:{amazon:"$229.00",andertons:"£299.00",gear4music:"£239.00",musicstore:"€139.00"},urls:{zzounds:"https://www.zzounds.com/a--925521/item--YAMFG800"},oos:["zzounds"]},
  103: {prices:{amazon:"$329.99",zzounds:"$359.99",andertons:"£269.00",musicstore:"€329.00"},urls:{gear4music:"https://www.gear4music.com/Guitar-and-Bass/Yamaha-Pacifica-112-V-Black/842"},oos:["gear4music"]},
  104: {prices:{amazon:"$3,499.99",andertons:"£3,599.00",musicstore:"€3,499.00"},urls:{zzounds:"https://www.zzounds.com/a--925521/item--MRTD28",gear4music:"https://www.gear4music.com/Guitar-and-Bass/Martin-D-28/26U7"},oos:["zzounds","gear4music"]},
  ...
  107: {prices:{amazon:"$469.00",zzounds:"$469.00",andertons:"£398.00",gear4music:"£419.00",musicstore:"€444.00"},urls:{gear4music:"https://www.gear4music.com/PA-DJ-and-Lighting/Shure-BLX24R-SM58-K3E-Rack-Mount-Wireless-Microphone-System/TU6",zzounds:"https://www.zzounds.com/a--925521/item--SHUBLX24RSM58"},oos:["gear4music","zzounds"]},
  ...
  110: {prices:{amazon:"$749.00",andertons:"£599.00",gear4music:"£529.00",musicstore:"€599.00"}},
  112: {prices:{amazon:"$165.00",zzounds:"$179.00",gear4music:"£192.25",musicstore:"€299.00",andertons:"£199.00"}},
  113: {prices:{gear4music:"£594.00",amazon:"$599.00",andertons:"£549.00",zzounds:"$599.00",musicstore:"€599.00",pluginboutique:"$805"}},
  114: {prices:{gear4music:"£299.00",amazon:"$579.99",andertons:"£299.00",zzounds:"$579.99",musicstore:"€339.00",pluginboutique:"$579.99"}},
  115: {prices:{andertons:"£299.00",gear4music:"£245.00",amazon:"$399.00",pluginboutique:"$299.00"}},
  116: {prices:{amazon:"$129.00",andertons:"£112.00",gear4music:"£115.00",musicstore:"€155.00"},urls:{zzounds:"https://www.zzounds.com/a--925521/item--JBLLSR305PMKII"},oos:["zzounds"]},
  117: {prices:{amazon:"$249.00",zzounds:"$249.00",andertons:"£169.00",gear4music:"£169.00",musicstore:"€199.00"}},
  119: {prices:{pluginboutique:"$39.00"},urls:{zzounds:"https://www.zzounds.com/item--WAVSSLNAT"},oos:["zzounds"],na:["gear4music","musicstore"]},
  ...
  122: {prices:{pluginboutique:"$1,399.00",gear4music:"£1,299.00",musicstore:"€1,349.00",andertons:"£1,299.00"}},
  ...
  126: {prices:{gear4music:"£1,742.00",amazon:"$1,839.99",zzounds:"$1,839.99",musicstore:"€1,517.56"},oos:["andertons"]},
  ...
  135: {prices:{amazon:"$679.00",zzounds:"$679.00",andertons:"£679.00",gear4music:"£679.00",musicstore:"€699.00"}},
  ...
  138: {prices:{amazon:"$1,398.00",andertons:"£991.00",gear4music:"£1,037.00",musicstore:"€1,298.00"},urls:{zzounds:"https://www.zzounds.com/productreview--BEHX32COMPACT"},oos:["zzounds"]},
  139: {prices:{gear4music:"£3,050.00",amazon:"$3,999.00",andertons:"£2,599.00",musicstore:"€2,990.00"},urls:{zzounds:"https://www.zzounds.com/a--925521/item--AAHSQ5"},oos:["zzounds"]},
  ...
  143: {prices:{amazon:"$1,899.00",zzounds:"$1,899.00",andertons:"£1,525.00",gear4music:"£1,634.00",musicstore:"€1,999.00"}},
  144: {prices:{gear4music:"£286.00",amazon:"$299.99",andertons:"£249.00",zzounds:"$299.00",musicstore:"€299.00"}},
  145: {prices:{amazon:"$509.00",andertons:"£315.00",gear4music:"£315.00",musicstore:"€369.00"},urls:{zzounds:"https://www.zzounds.com/productreview--BEHXR18"},oos:["zzounds"]},
  146: {prices:{amazon:"$380.00",zzounds:"$379.99",andertons:"£281.00",gear4music:"£291.50",musicstore:"€349.00"}},
  147: {prices:{amazon:"$1,099.99",zzounds:"$1,199.99",andertons:"£829.00",gear4music:"£835",musicstore:"€929.00"}},
  148: {prices:{gear4music:"£2,009.00",amazon:"$2,499.00",andertons:"£1,452.00",musicstore:"€2,099.00"},urls:{zzounds:"https://www.zzounds.com/a--925521/item--MIDM32RLIVE"},oos:["zzounds"]},
  ...
  155: {prices:{amazon:"$1,689.99",zzounds:"$1,889.99",gear4music:"£1,879.00",musicstore:"€1,775.63"},oos:["andertons"]},
  156: {prices:{amazon:"$1,739.99",zzounds:"$1,939.99",andertons:"£1,799.00",musicstore:"€1,847.90",gear4music:"£1,849.00"}},
  157: {prices:{amazon:"$529.99",andertons:"£399.00",gear4music:"£389.00",musicstore:"€354.12"},urls:{zzounds:"https://www.zzounds.com/a--925521/item--SQU0303075"},oos:["zzounds"]},
  ...
  162: {prices:{amazon:"$749.00",andertons:"£799.00",gear4music:"£599.00"},urls:{zzounds:"https://www.zzounds.com/a--925521/item--EPIEBTV"},oos:["musicstore","zzounds"]},
  ...
  175: {prices:{gear4music:"£4,337.00",amazon:"$4,399.99",zzounds:"$4,399.99",andertons:"£3,899.00",musicstore:"€4,679.00"}},
  ...
  182: {prices:{amazon:"$4,999.00",zzounds:"$3,899.00",andertons:"£3,821.00",gear4music:"£3,859.00"},urls:{musicstore:"https://www.musicstore.com/en_OE/EUR/search?SearchText=Universal%20Audio%20Apollo%20x16"},na:["musicstore"]},
  ...
  191: {prices:{gear4music:"£363.50",amazon:"$479.00",zzounds:"$399.99",musicstore:"€461.34"},oos:["andertons"]},
  192: {prices:{amazon:"$424.99",zzounds:"$424.99",andertons:"£451.00",gear4music:"£263.00",musicstore:"€432.77"}},
  193: {prices:{gear4music:"£350.00",amazon:"$499.99",zzounds:"$499.99",andertons:"£349.00",musicstore:"€419.00"}},
  ...
  196: {prices:{amazon:"$99.00",zzounds:"$119.00",andertons:"£79.00",gear4music:"£80.60",musicstore:"€98.00"}},
  ...
  201: {prices:{amazon:"$83.90",andertons:"£58.00",gear4music:"£70.00",musicstore:"€66.00"},urls:{zzounds:"https://www.zzounds.com/a--925521/item--TCEDITTO"},oos:["zzounds"]},
  ...
  206: {prices:{amazon:"$1,599.00",zzounds:"$1,599.00",andertons:"£1,399.00",gear4music:"£1,399.00",musicstore:"€1,799.00"}},
  ...
  209: {prices:{amazon:"$1,399.00",andertons:"£879.00"},urls:{gear4music:"https://www.gear4music.com/Recording-and-Computers/Austrian-Audio-OC818-Studio-Set-Black/4PIK",zzounds:"https://www.zzounds.com/a--925521/item--AAUOC818STUDSET"},oos:["zzounds","gear4music"]},
  ...
  214: {prices:{amazon:"$429.00",zzounds:"$429.00",andertons:"£295.00",musicstore:"€360.00"},urls:{gear4music:"https://www.gear4music.com/search?q=Sennheiser%20e604%203-Pack"},na:["gear4music"]},
  215: {prices:{gear4music:"£532.00",amazon:"$660.00",andertons:"£405.00",musicstore:"€461.34"},urls:{zzounds:"https://www.zzounds.com/a--925521/item--DPAVO4099D"},oos:["zzounds"]},
  216: {prices:{gear4music:"£1,016.00",amazon:"$1,699.00",andertons:"£899.00",musicstore:"€1,091.60"},urls:{zzounds:"https://www.zzounds.com/a--925521/item--RCFNX912SMA"},oos:["zzounds"]},
  ...
  222: {},
  223: {prices:{gear4music:"£2,149.99",amazon:"$3,499.00",musicstore:"€2,629.00"},oos:["andertons"]},
  224: {prices:{gear4music:"£1,786.00",amazon:"$2,299.00",zzounds:"$2,299.00",musicstore:"€1,998.00",andertons:"£1,675.00"}},
  226: {prices:{amazon:"$179.00",zzounds:"$179.00",andertons:"£163.00",musicstore:"€150.42",gear4music:"£161.50"}},
  ...
  231: {prices:{amazon:"$259.00",andertons:"£236.00",gear4music:"£236.50",musicstore:"€335.29"},urls:{zzounds:"https://www.zzounds.com/a--925521/item--AUDOM7"},oos:["zzounds"]},
  232: {prices:{amazon:"$169.00",zzounds:"$169.00",andertons:"£129.00",gear4music:"£136.00",musicstore:"€158.82"}},
  233: {prices:{amazon:"$2,199.99",zzounds:"$2,199.99",andertons:"£1,599.00",gear4music:"£1,770.00",musicstore:"€1,931.93"}},
  234: {prices:{amazon:"$3,499.00",zzounds:"$3,849.00",andertons:"£2,549.00"},urls:{musicstore:"https://www.musicstore.com/en_OE/EUR/search?SearchText=RCF%20SUB%208004-AS"},oos:["gear4music"],na:["musicstore"]},
  235: {prices:{amazon:"$999.00",zzounds:"$899.00",andertons:"£803.00",gear4music:"£899.00",musicstore:"€1,069.00"}},
  ...
  239: {prices:{amazon:"$438.50",zzounds:"$488.00",andertons:"£386.00",gear4music:"£434.00",musicstore:"€398.00"}},
  240: {prices:{gear4music:"£358.00",amazon:"$499.99",zzounds:"$459.99",musicstore:"€251.26"},oos:["andertons"]},
  243: {prices:{amazon:"$159.99",musicstore:"€167.23"},oos:["andertons"]},
  244: {prices:{gear4music:"£239.50",amazon:"$249.00",zzounds:"$229.00",musicstore:"€293.28"},oos:["andertons"]},
  ...
  249: {prices:{amazon:"$219.00",musicstore:"€259.00"}},
  ...
  254: {prices:{musicstore:"€99.00"},urls:{musicstore:"https://www.musicstore.com/en_OE/EUR/DJI-Mic-Mini-2-2-TX-1-RX-Charging-Case-/art-REC0017234-000"}},
  255: {prices:{amazon:"$449.99",zzounds:"$519.99",andertons:"£452.00",gear4music:"£549",musicstore:"€419.33"}},
  256: {prices:{amazon:"$799.00",zzounds:"$799.00",andertons:"£719.00",gear4music:"£829",musicstore:"€849.00"}},
  ...
  266: {prices:{gear4music:"£1,135.00",amazon:"$1,749.00",zzounds:"$1,749.00",andertons:"£1,180.00",musicstore:"€1,349.00"}},
  267: {prices:{amazon:"$419.99",zzounds:"$419.99",andertons:"£859.00",gear4music:"£819.00",musicstore:"€399.00"}},
  268: {prices:{amazon:"$1,699.95"},oos:["andertons"]},
  269: {prices:{amazon:"$989.00",zzounds:"$999.00",andertons:"£866.00",gear4music:"£813",musicstore:"€1,049.00"}},
  270: {prices:{amazon:"$219.99"},oos:["andertons","musicstore"]},
  271: {prices:{amazon:"$499.00",andertons:"£449.00",gear4music:"£425.00",musicstore:"€485.00"},urls:{zzounds:"https://www.zzounds.com/item--TAYGSMINI"},oos:["zzounds"]},
  272: {prices:{amazon:"$879.99",andertons:"£699.00",gear4music:"£749.00",musicstore:"€789.00"}},
  273: {prices:{amazon:"$879.99",andertons:"£699.00",gear4music:"£706.00",musicstore:"€799.00"}},
  274: {prices:{gear4music:"£309.00",amazon:"$239.99",musicstore:"€335.29"},oos:["andertons"]},
  275: {prices:{gear4music:"£349.00",amazon:"$329.99",musicstore:"€399.00"},urls:{zzounds:"https://www.zzounds.com/item--TRAULNY"},oos:["andertons","zzounds"]},
  ...
  280: {prices:{amazon:"$41.00",zzounds:"$39.99",gear4music:"£36.00",musicstore:"€32.77"},oos:["andertons"]},
  281: {prices:{amazon:"$45.00",zzounds:"$44.99",gear4music:"£39.00",musicstore:"€35.29"},oos:["andertons"]},
  284: {prices:{amazon:"$30.00"},oos:["andertons"]},
  286: {prices:{gear4music:"£135.50",amazon:"$159.00",andertons:"£129.00",musicstore:"€145.00",zzounds:"$159.00"}},
  287: {prices:{amazon:"$19.99",zzounds:"$19.99",gear4music:"£17.00",musicstore:"€15.97"},oos:["andertons"]},
  289: {prices:{amazon:"$32.99"},oos:["andertons"]},
  290: {prices:{gear4music:"£99.99",amazon:"$149.00",zzounds:"$109.00"},oos:["andertons"]},
  291: {prices:{gear4music:"£149.00",amazon:"$168.00",zzounds:"$169.00",andertons:"£149.00",musicstore:"€167.00"},urls:{gear4music:"https://www.gear4music.com/Recording-and-Computers/Audio-Technica-AT2020USBX-Cardioid-Condenser-Microphone/528M"},oos:["gear4music"]},
  292: {prices:{amazon:"$103.00",zzounds:"$105.00",gear4music:"£84.20",andertons:"£85.00",musicstore:"€95.00"}},
  293: {prices:{gear4music:"£299.00",amazon:"$329.99",zzounds:"$369.99",andertons:"£299.00",musicstore:"€320.00"}},
  ...
  299: {prices:{gear4music:"£104.99",amazon:"$198.00",zzounds:"$199.00",andertons:"£159.00",musicstore:"€143.00"}},
  ...
  302: {prices:{gear4music:"£499.00",amazon:"$599.99",zzounds:"$299.99",andertons:"£249.00",musicstore:"€489.00"}},
  303: {prices:{gear4music:"£293.50",amazon:"$395.00",andertons:"£288.00",musicstore:"€438.66"},urls:{zzounds:"https://www.zzounds.com/a--925521/item--GEN8010APM"},oos:["zzounds"]},
  304: {prices:{andertons:"£449.00",gear4music:"£249.99",amazon:"$599.00",musicstore:"€250.42"},urls:{zzounds:"https://www.zzounds.com/a--925521/item--KAAINUNF"},oos:["zzounds"]},
  ...
  308: {prices:{gear4music:"£650.00",amazon:"$799.99",zzounds:"$799.99",andertons:"£609.00",musicstore:"€399.00"}},
  ...
  321: {prices:{gear4music:"£511.00",amazon:"$549.00",zzounds:"$549.00",andertons:"£508.00",musicstore:"€539.00"}},
  ...
  330: {prices:{gear4music:"£16.80",amazon:"$20.99",andertons:"£16.00",musicstore:"€22.00"},urls:{zzounds:"https://www.zzounds.com/item--BEHXM8500"},oos:["zzounds"]},
  ...
  338: {prices:{andertons:"£1,019.00",musicstore:"€587.39"},urls:{gear4music:"https://www.gear4music.com/Recording-and-Computers/Genelec-7050C-Subwoofer/8M",zzounds:"https://www.zzounds.com/a--925521/item--GEN7050CPM"},oos:["gear4music","zzounds"]},
  339: {prices:{gear4music:"£739.00",amazon:"$999.00",zzounds:"$999.00",andertons:"£739.00",musicstore:"€839.34"}},
  340: {prices:{amazon:"$485.00",zzounds:"$485.00",andertons:"£472.00",gear4music:"£491.00",musicstore:"€478.15"}},
  341: {prices:{amazon:"$559.00",zzounds:"$641.52",gear4music:"£564.00",musicstore:"€574.79"},oos:["andertons"]},
  342: {prices:{amazon:"$329.95",zzounds:"$349.00",andertons:"£222.00",gear4music:"£223.50",musicstore:"€221.85"}},
  ...
  345: {prices:{gear4music:"£191.50",amazon:"$239.40",zzounds:"$239.40",andertons:"£219.00",musicstore:"€239.00"}},
  ...
  350: {prices:{zzounds:"$228.99",amazon:"$228.99"},oos:["musicstore","andertons"]},
  352: {prices:{gear4music:"£179.00",amazon:"$189.00",zzounds:"$249.99",andertons:"£189.00",musicstore:"€158.80"}},
  353: {prices:{gear4music:"£499.00",amazon:"$529.99",musicstore:"€539.00"},oos:["andertons"]},
  354: {prices:{gear4music:"£499.00",andertons:"£379.00",amazon:"$599.00",musicstore:"€419.33"},urls:{zzounds:"https://www.zzounds.com/a--925521/item--PAUSEP20F"},oos:["zzounds"]},
  355: {prices:{gear4music:"£339.00",musicstore:"€335.29"},urls:{amazon:"https://www.amazon.com/dp/B009WU5SV0",zzounds:"https://www.zzounds.com/a--925521/item--EPIEE00"},oos:["amazon","zzounds","andertons"]},
  356: {prices:{gear4music:"£189.00",amazon:"$199.99",musicstore:"€219.00"},oos:["andertons"]},
  357: {prices:{gear4music:"£515.00",amazon:"$599.99",andertons:"£485.00",musicstore:"€604.20"}},
  ...
  364: {prices:{amazon:"$507.99",zzounds:"$1,049.99",andertons:"£799.00",gear4music:"£788.00",musicstore:"€798.00"},urls:{gear4music:"https://www.gear4music.com/Recording-and-Computers/beyerdynamic-M160-Double-Ribbon-Microphone/92T"}},
  365: {prices:{amazon:"$477.73",zzounds:"$519.00",andertons:"£323.00",gear4music:"£466.00",musicstore:"€436.13"},urls:{gear4music:"https://www.gear4music.com/Recording-and-Computers/sE-Electronics-VR2-Voodoo-Active-Ribbon-Mic/DRQ",zzounds:"https://www.zzounds.com/item--SEEVR2"}},
  366: {prices:{amazon:"$99.95",zzounds:"$99.95"},urls:{zzounds:"https://www.zzounds.com/item--MXLR144HE"},oos:["zzounds","andertons"]},
  ...
  372: {prices:{amazon:"$795.00",andertons:"£517.00",gear4music:"£540.00",musicstore:"€453.78"},urls:{zzounds:"https://www.zzounds.com/item--GEN8030CP"},oos:["zzounds"]},
  374: {prices:{pluginboutique:"$99.00"},urls:{pluginboutique:"https://www.pluginboutique.com/product/2-Effects/6-Action/10606-ShaperBox-3",amazon:"https://www.amazon.com/?tag=topmusicg-20"},na:["andertons","gear4music","musicstore"]},
  375: {prices:{pluginboutique:"$99.00",gear4music:"£42.00",musicstore:"€49.00",amazon:"$99.00"},urls:{gear4music:"https://www.gear4music.com/Recording-and-Computers/XLN-Audio-RC-20-Retro-Color/3NGQ",pluginboutique:"https://www.pluginboutique.com/product/2-Effects/6-Action/6842-RC-20-Retro-Color",musicstore:"https://www.musicstore.com/en_OE/EUR/XLN-Audio-RC-20-Retro-Color/art-PCM0018798-000",amazon:"https://www.amazon.com/XLN-Audio-RC-20-Retro-Color/dp/B08JSYBDY1"}},
  376: {prices:{pluginboutique:"$12.00"},urls:{pluginboutique:"https://www.pluginboutique.com/product/2-Effects/6-Action/6524-HalfTime",amazon:"https://www.amazon.com/?tag=topmusicg-20"},na:["andertons","gear4music","musicstore"]},
  377: {prices:{pluginboutique:"$129.00",gear4music:"£111.00",andertons:"£99.00",musicstore:"€129.00",amazon:"$129.00"},urls:{gear4music:"https://www.gear4music.com/Recording-and-Computers/Baby-Audio-Transit-2/6RY2",andertons:"https://www.andertons.co.uk/baby-audio-transit-2-motion-effects-plugin/",pluginboutique:"https://www.pluginboutique.com/product/2-Effects/6-Action/10358-Transit-2",musicstore:"https://www.musicstore.com/en_OE/EUR/Baby-Audio-Transit-2-License-Code/art-PCM0018531-000",amazon:"https://www.amazon.com/Baby-Audio-Transit-2-Plugin/dp/B0DCJ5LPZL"}},
  378: {prices:{pluginboutique:"$89.00",andertons:"£82.80",gear4music:"£82.80"}},
  379: {prices:{pluginboutique:"$175.00"}},
  380: {prices:{pluginboutique:"$129.99"},urls:{pluginboutique:"https://www.pluginboutique.com/product/2-Effects/53-Multi-Effect-/7627-Infiltrator-2",amazon:"https://www.amazon.com/?tag=topmusicg-20"},na:["andertons","gear4music","musicstore"]},
  381: {prices:{pluginboutique:"$299.00",gear4music:"£231.00",andertons:"£252.00",musicstore:"€242.90",amazon:"$299"},urls:{gear4music:"https://www.gear4music.com/Recording-and-Computers/iZotope-Neutron-5-Advanced/6U5K",andertons:"https://www.andertons.co.uk/izotope-neutron-5-standard--esd/",pluginboutique:"https://www.pluginboutique.com/product/2-Effects/21-Channel-Strip/13502-Neutron-5",musicstore:"https://www.musicstore.com/en_OE/EUR/iZotope-Neutron-5-License-Code/art-PCM0018250-000",amazon:"https://www.amazon.com/iZotope-Neutron-5-Advanced/dp/B0DF83BWHX"}},
  382: {prices:{pluginboutique:"$99.00",amazon:"$99.00"},urls:{pluginboutique:"https://www.pluginboutique.com/product/4-Synth/11533-Scaler-3",amazon:"https://www.amazon.com/Plugin-Boutique-Scaler-3-Software/dp/B0FKK2H83D"},na:["andertons","gear4music","musicstore"]},
  383: {prices:{pluginboutique:"$129.00",gear4music:"£62.00",musicstore:"€105.00",amazon:"$129.00"},urls:{gear4music:"https://www.gear4music.com/Recording-and-Computers/Sonible-SmartEQ-4/65LT",pluginboutique:"https://www.pluginboutique.com/product/2-Effects/16-EQ/11784-smart-EQ-4",musicstore:"https://www.musicstore.com/en_OE/EUR/Sonible-smart-EQ-4-License-Code/art-PCM0017947-000",amazon:"https://www.amazon.com/Sonible-smartEQ-4/dp/B0CVHRCRW2"},na:["andertons"]},
  384: {prices:{pluginboutique:"$129.00",gear4music:"£62.00",musicstore:"€105.00",amazon:"$129.00"},urls:{gear4music:"https://www.gear4music.com/Recording-and-Computers/Sonible-SmartLimit/4M4S",pluginboutique:"https://www.pluginboutique.com/product/2-Effects/6-Action/9008-smartlimit",musicstore:"https://www.musicstore.com/en_OE/EUR/Sonible-Smart-limit-License-Code/art-PCM0017210-000",amazon:"https://www.amazon.com/Sonible-smartlimit-Plugin/dp/B0C8J4WJF1"},na:["andertons"]},
  385: {prices:{pluginboutique:"$80.00"}},
  386: {prices:{pluginboutique:"$99.00",gear4music:"£62.55",andertons:"£95.00",musicstore:"€83.20",amazon:"$99.00"},urls:{gear4music:"https://www.gear4music.com/Recording-and-Computers/iZotope-Trash/6AAU",andertons:"https://www.andertons.co.uk/izotope-trash-creative-distortion-plugin/",pluginboutique:"https://www.pluginboutique.com/product/2-Effects/6-Action/12095-Trash",musicstore:"https://www.musicstore.com/en_OE/EUR/iZotope-Trash-License-Code/art-PCM0018334-000",amazon:"https://www.amazon.com/iZotope-Trash-Distortion-Plugin/dp/B0DF84C84J"}},
  387: {prices:{pluginboutique:"$79.00",amazon:"$79.00"},urls:{pluginboutique:"https://www.pluginboutique.com/product/2-Effects/6-Action/11521-Lifeline-Expanse",amazon:"https://www.amazon.com/Excite-Audio-Lifeline-Expanse-Plugin/dp/B0DKF74MVH"},na:["andertons","gear4music","musicstore"]},
  389: {prices:{gear4music:"£128.00",pluginboutique:"$49.00",musicstore:"€49.00"},urls:{amazon:"https://www.amazon.com/?tag=topmusicg-20"}},
  ...
  395: {prices:{amazon:"$467.46",zzounds:"$499.99",gear4music:"£449.00",andertons:"£419.00",musicstore:"€529.00"}},
  396: {prices:{amazon:"$419.00",gear4music:"£266.00",andertons:"£266.00",musicstore:"€298.00"},urls:{zzounds:"https://www.zzounds.com/a--925521/item--BEHXTOUCH"},oos:["zzounds"]},
  397: {prices:{amazon:"$699.99",zzounds:"$699.99",gear4music:"£496.00",andertons:"£496.00",musicstore:"€639.00"}},
  398: {prices:{zzounds:"$1,495.00",musicstore:"€1,349.00",amazon:"$1,295",andertons:"£1,549.00"}},
  399: {prices:{musicstore:"€318.49"},urls:{amazon:"https://www.amazon.com/dp/B071XHN18K",zzounds:"https://www.zzounds.com/a--925521/item--ICNPLATFORMMPLUS"},oos:["amazon","zzounds"]},
  400: {prices:{amazon:"$1,299.99",zzounds:"$1,399.99",musicstore:"€1,032.77"},oos:["andertons"]},
  401: {prices:{amazon:"$899.00",gear4music:"£770.00",andertons:"£849.00",musicstore:"€899.00",zzounds:"$999.00"}},
  402: {prices:{amazon:"$1,999.00",gear4music:"£1,447.00",andertons:"£1,234.00",musicstore:"€1,306.72"},urls:{zzounds:"https://www.zzounds.com/a--925521/item--BEHX32"},oos:["zzounds"]},
  403: {prices:{gear4music:"£3,139.00",amazon:"$2,499",andertons:"£2,599.00",musicstore:"€2,501.68"},urls:{zzounds:"https://www.zzounds.com/a--925521/item--MIDM32LIVE"},oos:["zzounds"]},
  406: {prices:{zzounds:"$1,599.99",gear4music:"£1,510.00",amazon:"$1,599.99",andertons:"£1,510.00",musicstore:"€1,503.36"}},
  408: {prices:{zzounds:"$1,399.99",amazon:"$1,399.99",gear4music:"£1,036.00",musicstore:"€1,365.46"},oos:["andertons"]},
  410: {prices:{amazon:"$1,499.00",zzounds:"$1,499.00",gear4music:"£719.00",andertons:"£749.00",musicstore:"€869.00"}},
  ...
  413: {prices:{amazon:"$1,689.99",musicstore:"€1,427.73",andertons:"£1,399.00"}},
  ...
  421: {prices:{amazon:"$249.00",gear4music:"£200.50",musicstore:"€215.00"}},
  ...
  429: {prices:{amazon:"$75.99",zzounds:"$79.99",gear4music:"£69.00",musicstore:"€63.03"},oos:["andertons"]},
  430: {prices:{amazon:"$39.99",zzounds:"$39.99",gear4music:"£35.00",musicstore:"€31.93"},oos:["andertons"]},
  ...
  434: {prices:{amazon:"$79.99",gear4music:"£95.00",musicstore:"€88.24"},oos:["andertons"]},
  ...
  444: {prices:{amazon:"$849.99",zzounds:"$849.99",gear4music:"£699.00",musicstore:"€671.43",andertons:"£799.00"}},
  ...
  451: {prices:{amazon:"$229.00",gear4music:"£199.00",musicstore:"€209.20",andertons:"£199.00"},urls:{zzounds:"https://www.zzounds.com/item--LRBPARADI"},oos:["zzounds"]},
  452: {prices:{zzounds:"$4,599.99",amazon:"$4,399.00",gear4music:"£4,749.00",andertons:"£4,599.00"},urls:{gear4music:"https://www.gear4music.com/Guitar-and-Bass/Martin-D-28-Modern-Deluxe/2WVL"},oos:["gear4music"]},
  453: {prices:{andertons:"£6,799.00"},urls:{amazon:"https://www.amazon.com/dp/B079V26HMV"},oos:["amazon"]},
  454: {prices:{zzounds:"$5,999.00",gear4music:"£4,499.00"},urls:{amazon:"https://www.amazon.com/dp/B0D777R4L2",gear4music:"https://www.gear4music.com/Guitar-and-Bass/Taylor-Builders-Edition-914ce-Sinker-Redwood-Top-Honduran-Rosewood-Back-and-Sides/7M78"},oos:["amazon","gear4music"]},
  455: {prices:{zzounds:"$8,999.00",gear4music:"£7,499.00"},urls:{amazon:"https://www.amazon.com/dp/B0BD48TMYK"},oos:["amazon"]},
  456: {prices:{zzounds:"$4,999.00",gear4music:"£4,599.00",andertons:"£4,199.00",musicstore:"€3,734.50"},urls:{amazon:"https://www.amazon.com/dp/B001R2ITEE",gear4music:"https://www.gear4music.com/Guitar-and-Bass/Gibson-1942-Banner-J-45-Vintage-Sunburst/39E5"},oos:["amazon","gear4music"]},
  457: {prices:{zzounds:"$5,699.00",gear4music:"£4,499.00",andertons:"£5,699.00",musicstore:"€4,031.90"},urls:{amazon:"https://www.amazon.com/dp/B0CTKDGRHP"},oos:["amazon"]},
  458: {prices:{amazon:"$199.99"},urls:{gear4music:"https://www.gear4music.com/Guitar-and-Bass/Epiphone-Les-Paul-Special-Satin-E1-Les-Paul-Special-VE-Ebony/1LQB"},oos:["gear4music"]},
  ...
  468: {prices:{andertons:"£3,399.00",musicstore:"€3,869.00"},urls:{amazon:"https://www.amazon.com/dp/B0FSGYBWZQ",musicstore:"https://www.musicstore.com/en_OE/EUR/Neumann-KH-810-II/art-REC0017051-000",andertons:"https://www.andertons.co.uk/neumann-kh-810-ii-10-active-subwoofer/",zzounds:"https://www.zzounds.com/item--NEMKH810II"},na:["gear4music"]},
  470: {},
  ...
  479: {prices:{zzounds:"$2,999.00",andertons:"£2,199.00",musicstore:"€2,590.00"}},
  480: {prices:{andertons:"£2,599.00",musicstore:"€2,829.00"},oos:["zzounds"]},
  481: {},
  ...
  485: {prices:{gear4music:"£999.00",andertons:"£1,099.00",amazon:"$1,099.99"}},
  486: {prices:{zzounds:"$499.00",amazon:"$525.00",andertons:"£422.00",gear4music:"£458.00",musicstore:"€444.00"}},
  487: {prices:{amazon:"$585.00"},urls:{zzounds:"https://www.zzounds.com/item--SOUSIG12MTK"},oos:["zzounds"]},
  488: {prices:{zzounds:"$349.99",amazon:"$318.99",andertons:"£319.00",gear4music:"£285.50"}},
  489: {prices:{zzounds:"$199.00",amazon:"$199.00",andertons:"£199.99",musicstore:"€179.00"}},
  490: {prices:{zzounds:"$269.99",andertons:"£319.00",gear4music:"£319.00",musicstore:"€299.00"}},
  491: {prices:{zzounds:"$249.00",amazon:"$249.00",andertons:"£179.00",gear4music:"£165.00",musicstore:"€199.00"}},
  492: {prices:{zzounds:"$449.99",amazon:"$328.98",andertons:"£349.00",gear4music:"£349.00",musicstore:"€399.00"}},
  493: {prices:{zzounds:"$569.00",amazon:"$439.20",andertons:"£459.00",gear4music:"£463.00",musicstore:"€549.00"}},
  494: {prices:{zzounds:"$529.99",andertons:"£368.00",gear4music:"£374.00",musicstore:"€429.00"}},
  495: {prices:{zzounds:"$949.00",amazon:"$849.00",gear4music:"£659.00",musicstore:"€819.00"},oos:["andertons"]},
  496: {prices:{zzounds:"$1,099.00",amazon:"$1,099.00",andertons:"£1,049.00",musicstore:"€1,199.00"},oos:["gear4music"]},
  497: {prices:{zzounds:"$415.00",amazon:"$399.00",gear4music:"£335.50",musicstore:"€365.00"}},
  499: {prices:{zzounds:"$267.00",gear4music:"£354.00",musicstore:"€389.00"}},
...
503: {prices:{gear4music:"£439.00",amazon:"$599.99",zzounds:"$599.99",andertons:"£439.00",musicstore:"€499.00"}},
  504: {holly:{eu:{u:"https://eu.hollyland.com/de-de/products/lark-max",p:"€143.00"},us:{u:"https://store.hollyland.com/products/lark-max",p:"$139.00"}},na:["zzounds","reverb","gear4music","andertons","musicstore","amazon"]},
  ...
  506: {holly:{eu:{u:"https://eu.hollyland.com/de-de/products/lark-max-2?variant=51364345807115",p:"€212.00"},us:{u:"https://store.hollyland.com/products/lark-max-2?variant=46839711826179",p:"$269.00"},uk:{u:"https://uk.hollyland.com/products/lark-max-2?variant=48696453267684",p:"£180.20"}},prices:{amazon:"$249.00"},na:["zzounds","reverb","gear4music","andertons","musicstore"]},
  ...
  509: {holly:{eu:{u:"https://eu.hollyland.com/de-de/products/solidcom-c1?variant=45698861072651",p:"€364.00"},us:{u:"https://store.hollyland.com/products/solidcom-c1?variant=42779547435267",p:"$399.00"},uk:{u:"https://uk.hollyland.com/products/solidcom-c1?variant=49084502081764",p:"£309.40"}},prices:{amazon:"$399.00"},na:["zzounds","reverb","gear4music","andertons","musicstore"]},
  510: {holly:{eu:{u:"https://eu.hollyland.com/de-de/products/solidcom-c1-pro?variant=45698811003147",p:"€589.00"},us:{u:"https://store.hollyland.com/products/solidcom-c1-pro?variant=43796065779971",p:"$649.00"},uk:{u:"https://uk.hollyland.com/products/solidcom-c1-pro?variant=49084560507108",p:"£539.00"}},prices:{amazon:"$649.00"},na:["zzounds","reverb","gear4music","andertons","musicstore"]},
  511: {holly:{eu:{u:"https://eu.hollyland.com/de-de/products/solidcom-se-pro?variant=51170563358987",p:"€342.00"},us:{u:"https://store.hollyland.com/products/solidcom-se-pro?variant=46564892803331",p:"$369.00"},uk:{u:"https://uk.hollyland.com/products/solidcom-se-pro?variant=48696449302756",p:"£290.70"}},prices:{amazon:"$369.00"},na:["zzounds","reverb","gear4music","andertons","musicstore"]}
...
var faqBase = {
  ...
  daw: [
    { q: "What is the best DAW for music production?", q_es: "¿Cuál es el mejor DAW para producción musical?", a: "Ableton Live is the best for electronic music and beat-making, Pro Tools is the industry standard for recording and mixing, Logic Pro is excellent for songwriting on Mac, and Cubase offers powerful MIDI and scoring features. The best DAW depends on your workflow and genre.", a_es: "Ableton Live es ideal para música electrónica, Pro Tools es el estándar de la industria para grabación, Logic Pro es excelente para composición en Mac, y Cubase ofrece potentes funciones MIDI. El mejor DAW depende de tu flujo de trabajo." },
...
function navDropdown(isEs) {
  return `<div class="nav-dd">
    ...
    <div class="nav-dd-panel" role="menu">
      ...
      <a class="nav-dd-link" href="https://www.anrdoezrs.net/click-101857888-10439229?url=https%3A%2F%2Fwww.zzounds.com%2Flp%2Fnew-products%2F219" target="_blank" rel="noopener noreferrer sponsored"><img src="../img/zzounds-icon.png" alt="" class="nav-dd-link-icon">zZounds</a>
...
function buildGuidePage(guide, lang, idx) {
  ...
  const authorBoxHtml = `<div class="guide-author-box">
    <div class="guide-author-box-body">
      <span class="guide-author-box-name">${isEs ? 'Por Daniel Carnago · ' + fmtMonthYear(guide.datePublished, true) : 'By Daniel Carnago · ' + fmtMonthYear(guide.datePublished, false)}</span>
  ...
  <main id="mainContent">
    ...
    <div class="guide-detail">
      ...
      <div class="guide-product-card-currency-note">
        ...
        <div class="note-row"><span class="note-icon">🌍</span><span>${isEs ? 'Si un producto no está disponible, puede deberse a restricciones regionales. Según tu ubicación, una tienda puede mostrar el artículo como agotado, no venderlo en tu país o redirigirte a un producto similar al que buscas — ese comportamiento lo decide la propia tienda, no nosotros. Si ocurre, revisa las otras tiendas que mostramos, cada una con su propio inventario. Music Store te permite cambiar tu región desde su sitio para ver precios y disponibilidad en tu país.' : 'If a product shows as unavailable, it may be due to regional restrictions. Depending on your location, a store may show the item as out of stock, may not sell it in your country, or may redirect you to a similar product on their site — this is decided by the store itself, not by us. If that happens, check the other stores we list, each with its own inventory. Music Store lets you switch your region on their site to see prices and availability in your country.'}</span></div>
      </div>
...
<script>
(function(){
  var gText={zzounds:'zZounds',gear4music:'Gear4music',musicstore:'Music Store',andertons:'Andertons',reverb:'Reverb',amazon:'Amazon'};
  var gStyle={zzounds:"font-family:'Poppins',Arial,sans-serif;font-weight:800;font-style:italic;color:#fff;letter-spacing:-.5px;font-size:15px",gear4music:"font-family:'Quicksand','Segoe UI',sans-serif;font-weight:700;color:#fff;letter-spacing:-.3px;font-size:15px",andertons:"font-family:'Yellowtail',cursive;font-weight:400;color:#fff;font-size:19px",musicstore:"font-family:'Open Sans Condensed','Arial Narrow',Arial,sans-serif;font-weight:700;color:#fff;font-size:18px;letter-spacing:.5px",reverb:"font-family:'Kaushan Script',cursive;font-weight:400;color:#fff;font-size:17px"};
  function flagRect(inner){
    return '<svg viewBox="0 0 24 16" width="19" height="13" style="display:inline-block;vertical-align:-2px;flex-shrink:0;margin-right:5px"><defs><clipPath id="flgcGeo"><rect width="24" height="16" rx="3.2"/></clipPath></defs><g clip-path="url(#flgcGeo)">'+inner+'</g><rect x=".5" y=".5" width="23" height="15" rx="2.7" fill="none" stroke="#ffffff" stroke-opacity=".35"/></svg>';
  }
  function gFlag(k){
    if(k==='zzounds'){
      var s='<rect width="24" height="16" fill="#fff"/><g fill="#B22234">';
      [0,2.46,4.92,7.38,9.85,12.31,14.77].forEach(function(y){s+='<rect y="'+y+'" width="24" height="1.23"/>';});
      s+='</g><rect width="10" height="8.62" fill="#3C3B6E"/><g fill="#fff">';
      [[1.9,1.8],[4.1,1.8],[6.3,1.8],[8.5,1.8],[3,3.1],[5.2,3.1],[7.4,3.1],[1.9,4.4],[4.1,4.4],[6.3,4.4],[8.5,4.4],[3,5.7],[5.2,5.7],[7.4,5.7]].forEach(function(p){s+='<circle cx="'+p[0]+'" cy="'+p[1]+'" r=".42"/>';});
      return flagRect(s+'</g>');
    }
    if(k==='gear4music'||k==='andertons'){
      return flagRect('<rect width="24" height="16" fill="#012169"/><path d="M0,0 L24,16 M24,0 L0,16" stroke="#fff" stroke-width="3.4"/><path d="M0,0 L24,16 M24,0 L0,16" stroke="#C8102E" stroke-width="1.3"/><path d="M12,0 V16 M0,8 H24" stroke="#fff" stroke-width="5.6"/><path d="M12,0 V16 M0,8 H24" stroke="#C8102E" stroke-width="3.4"/>');
    }
    if(k==='musicstore'){
      var scx=12,scy=8,sr=5.5,ssr=1.35,pts=[],i,a,cx,cy,j,ao,ai,sp;
      for(i=0;i<12;i++){a=(i*30-90)*Math.PI/180;cx=scx+sr*Math.cos(a);cy=scy+sr*Math.sin(a);sp='';for(j=0;j<5;j++){ao=((j*72-90)*Math.PI/180);ai=(((j*72+36)-90)*Math.PI/180);sp+=(cx+ssr*Math.cos(ao)).toFixed(2)+','+(cy+ssr*Math.sin(ao)).toFixed(2)+' ';sp+=(cx+ssr*0.38*Math.cos(ai)).toFixed(2)+','+(cy+ssr*0.38*Math.sin(ai)).toFixed(2)+' ';}pts.push(sp.trim());}
      return '<svg viewBox="0 0 24 16" width="19" height="16" style="display:inline-block;vertical-align:-2px;flex-shrink:0;margin-right:5px"><defs><clipPath id="flgcGeo2"><rect width="24" height="16" rx="3.2"/></clipPath></defs><g clip-path="url(#flgcGeo2)"><rect width="24" height="16" fill="#003399"/>'+pts.map(function(p){return '<polygon points="'+p+'" fill="#FFCC00"/>';}).join('')+'</g><rect x=".5" y=".5" width="23" height="15" rx="2.7" fill="none" stroke="#ffffff" stroke-opacity=".35"/></svg>';
    }
    return '<svg viewBox="0 0 20 20" width="19" height="19" style="display:inline-block;vertical-align:-5px;flex-shrink:0;margin-right:5px"><defs><linearGradient id="glgGeo" x1="0" y1="0" x2="0" y2="1"><stop offset="0" stop-color="#67c6f8"/><stop offset="1" stop-color="#2563eb"/></linearGradient><clipPath id="glcGeo"><circle cx="10" cy="10" r="8.75"/></clipPath></defs><circle cx="10" cy="10" r="8.75" fill="url(#glgGeo)"/><g clip-path="url(#glcGeo)"><path d="M2.6,6.4 Q4.4,4.2 6.6,5 Q8.5,5.7 8.2,7.5 Q7.8,9.4 5.7,9.4 Q2.9,9.3 2.6,6.4 Z" fill="#34d399"/><path d="M11.6,3.2 Q13.8,2.6 14.9,4.4 Q15.8,6 13.9,6.9 Q12,7.7 11.2,5.9 Q10.5,4.3 11.6,3.2 Z" fill="#34d399"/><path d="M11.9,11.7 Q14,10.9 15.2,12.5 Q16.3,14.2 14.6,15.5 Q12.8,16.8 11.4,15.1 Q10.2,13.5 11.9,11.7 Z" fill="#22c55e"/><path d="M4.2,12.3 Q5.8,11.7 6.6,13 Q7.3,14.3 6,15.3 Q4.5,16.3 3.5,15 Q2.6,13.5 4.2,12.3 Z" fill="#22c55e"/><ellipse cx="10" cy="10" rx="4.4" ry="8.75" fill="none" stroke="#ffffff" stroke-opacity=".35" stroke-width=".7"/><path d="M1.25,10 H18.75" stroke="#ffffff" stroke-opacity=".35" stroke-width=".7"/></g><circle cx="10" cy="10" r="8.75" fill="none" stroke="#ffffff" stroke-opacity=".4"/></svg>';
  }
  function doSwap(T){
    ...
    if(ml&&!ml.querySelector('[data-store="'+curStore+'"]')){
      ...
      var dispRow='<a data-store="'+curStore+'" href="'+aUrl+'"'+aAffAttr+' target="_blank" rel="noopener noreferrer sponsored" style="width:100%;box-sizing:border-box;flex:none;min-height:40px;display:flex;align-items:center;gap:8px;padding:0 16px;height:40px;border-radius:12px;background:#333333;transition:transform .18s ease,background .18s ease,box-shadow .18s ease;color:#ffffff;text-decoration:none;font-size:15px;font-weight:800;border:none"><span style="display:flex;align-items:center">'+gFlag(curStore)+'<span style="'+(gStyle[curStore]||'font-weight:700')+'">'+(gText[curStore]||curStore)+'</span></span>'+dispNote+dispPriceSpan+'</a>';
      ml.insertAdjacentHTML('afterbegin',dispRow);
    }
  });
  }
  ...
  function gTrace(){
    ...
    t.open('GET','https://1.1.1.1/cdn-cgi/trace',true);
    t.timeout=4000;
    t.onload=function(){
      try{var m=/(?:^|\\n)loc=(\\S+)/.exec(t.responseText);if(m&&m[1])gApply(m[1]);}catch(e){}
    };
    t.send();
  }
  ...
  y.timeout=4000;
  y.onload=function(){
    try{var r=JSON.parse(y.responseText);if(r&&r.country)gApply(r.country);}catch(e){}
    gTrace();
  };
  y.onerror=y.ontimeout=function(){gTrace();};
  y.send();
})();
</script>
</body>
