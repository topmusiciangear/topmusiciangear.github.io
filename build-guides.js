...
<script>(function(){try{history.scrollRestoration='manual';var a=localStorage.getItem('tmg_v');fetch('/version.txt?t='+Date.now()).then(function(r){return r.text()}).then(function(b){if(!a){localStorage.setItem('tmg_v',b);return}if(a!==b){localStorage.setItem('tmg_v',b);var s=location.search.replace(/[?&]_v=[^&]*/,'');location.replace(location.pathname+s+(s?'&':'?')+'_v='+b)}})}catch(e){}})();!function(){var s=location.search.indexOf('_v=');if(s>-1&&history.replaceState)history.replaceState({},'',location.pathname+location.search.replace(/[?&]_v=[^&]*/,'')+location.hash)}()</script>
...
(function updateIndexHtml() {
  ...
  var verCheck = "<script>(function(){try{history.scrollRestoration='manual'}catch(e){}var a=localStorage.getItem('tmg_v');fetch('/version.txt?t='+Date.now()).then(function(r){return r.text()}).then(function(b){if(!a){localStorage.setItem('tmg_v',b);return}if(a!==b){localStorage.setItem('tmg_v',b);var s=location.search.replace(/[?&]_v=[^&]*/,'');location.replace(location.pathname+s+(s?'&':'?')+'_v='+b)}}).catch(function(){})})();!function(){var s=location.search.indexOf('_v=');if(s>-1&&history.replaceState)history.replaceState({},'',location.pathname+location.search.replace(/[?&]_v=[^&]*/,'')+location.hash)}()</script>";
