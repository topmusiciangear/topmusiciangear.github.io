...
'.hero-inner{font-family:-apple-system,BlinkMacSystemFont,"Segoe UI",sans-serif;max-width:960px;margin:0 auto;position:relative;z-index:1;display:flex;flex-direction:column;align-items:center;justify-content:center;min-height:calc(100vh - 64px)}',
    ...
    '.guide-comp-table{width:100%;border-collapse:separate;border-spacing:0;font-size:14px;contain:layout style}',
    ...
    '.guide-comp-scroll{overflow-x:auto;-webkit-overflow-scrolling:touch;scrollbar-width:none;flex:1 1 auto;min-width:0}.guide-comp-scroll::-webkit-scrollbar{display:none}.guide-comp-scroll-wrap{display:flex;align-items:center;gap:0;position:relative;margin:24px 0}.guide-comp-arrow{position:absolute;top:50%;transform:translateY(-50%);z-index:5;background:none;border:none;color:#fff;cursor:pointer;font-size:22px;line-height:1;padding:2px;box-shadow:none;-webkit-tap-highlight-color:transparent;display:inline-flex;align-items:center;justify-content:center;transition:color .2s}.guide-comp-arrow:hover,.guide-comp-arrow:active{color:var(--accent)}.guide-comp-arrow svg{width:1em;height:1em;filter:drop-shadow(0 0 6px rgba(0,0,0,.6))}.guide-comp-arrow-left{left:-27px}.guide-comp-arrow-right{right:-27px}',
    '@media(max-width:768px){.guide-comp-table{font-size:14px}.guide-comp-table td{padding:3px 4px}.guide-comp-table th{white-space:nowrap;padding:5px 4px}.guide-comp-title{font-size:17px;margin:4px 0 8px}.guide-comp-scroll-wrap{gap:0}.guide-comp-arrow{font-size:20px}.guide-comp-arrow-left{left:-27px}.guide-comp-arrow-right{right:-27px}}@media(max-width:480px){.guide-comp-arrow{font-size:18px}.guide-comp-arrow-left{left:-25px}.guide-comp-arrow-right{right:-25px}}',
