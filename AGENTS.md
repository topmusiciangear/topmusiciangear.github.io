...
- **REGLA IVA Music Store**: mostrar precios SIN IVA (internacional en_OT/en_OT), que es lo que el usuario ve al hacer clic en el link afiliado. NO multiplicar por 1.19. Si la pagina de_DE muestra precio con IVA (ej. 105), dividir entre 1.19 para obtener el precio internacional (88.24). El link afiliado apunta a en_OT/EUR donde el precio es SIN IVA.
...
- **Music Store SIN IVA**: los precios en TEST_SHOP_BTN deben ser SIN IVA (precio internacional en_OT/en_OT). El link afiliado apunta a la pagina internacional donde el usuario ve el precio sin IVA. NO multiplicar por 1.19. Si el precio viene de la pagina de_DE (con IVA), dividir entre 1.19.
