...
- **REGLA IVA Music Store**: mostrar precios SIN IVA (internacional en_OE/en_OE), que es lo que el usuario ve al hacer clic en el link afiliado. NO multiplicar por 1.19. Si la pagina de_DE muestra precio con IVA (ej. 105), dividir entre 1.19 para obtener el precio internacional (88.24). El link afiliado apunta a en_OE/EUR donde el precio es SIN IVA.
...
- **Music Store SIN IVA**: los precios en TEST_SHOP_BTN deben ser SIN IVA (precio internacional en_OE/en_OE). El link afiliado apunta a la pagina internacional donde el usuario ve el precio sin IVA. NO multiplicar por 1.19. Si el precio viene de la pagina de_DE (con IVA), dividir entre 1.19. **EXCEPCI�N (autorizada)**: si el usuario confirma que la pagina internacional en_OE/EUR muestra el precio CON IVA (ej. Komplete 26 = €1,249.00), usar ESE precio exacto en el bot�n para que coincida con la tienda, y ajustar la GUI�A del producto en consecuencia.
