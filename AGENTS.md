...
### Next Move
- Auditoría ES natural: seguir cazando traducciones literales tipo "grabar a un DAW"→"grabar en un DAW" en guías restantes (patrones de la sección Pendiente para mañana)
- **Mogami Gold Studio XLR (id 167)**: MS €45.00 + Andertons URL (ver bullet en "Pendiente para mañana") — aplicar con temp/apply_patch.js + regen + build + deploy
...
- **Mogami Gold Studio XLR Cable (id 167) — REPORTADO por el usuario (18/09/2026, pendiente de aplicar)**: (1) Music Store: el link actual (art-REC0015225-000) está bien y NO tiene precio → añadir `musicstore: "€45.00"` a TEST_SHOP_BTN; (2) Andertons: el link no abre y el usuario quiere que la fila enlace `aunque esté fuera de stock` a `https://www.andertons.co.uk/mogami-2534-quad-neglex-3m-xlrf-xlrm-mic-cable-neutrik-black-gold-xlr/?search_query=Mogami%20%20xlr` (se cumple con `urls:{andertons: "<esa URL>"}` vía rowUrl regla cfg.urls[k] primero). Entrada actual: `167: {prices:{amazon:"$53.95",zzounds:"$65.95",gear4music:"£44.99"},oos:["andertons"]}` →
  `167: {prices:{amazon:"$53.95",zzounds:"$65.95",gear4music:"£44.99",musicstore:"€45.00"},urls:{andertons:"https://www.andertons.co.uk/mogami-2534-quad-neglex-3m-xlrf-xlrm-mic-cable-neutrik-black-gold-xlr/?search_query=Mogami%20%20xlr"},oos:["andertons"]}`. Aplicar con temp/apply_patch.js (añadir a PRICES + OOSURLS/urls), regen shop-buttons.js + build + deploy.
- **Auditor�a de traducciones ES literales**: Buscar en guides.json y build-guides.js traducciones word-for-word del ingl�s que suenan raras en espa�ol. Buscar patrones como "a un DAW", "via USB", "grabacion" sin tilde, "tambien" sin tilde, "Seleccion", "conexion", "opcion", "informacion", "solucion", "Version", "condicion", "razon", "frecuencia", etc. Tambi�n buscar frases como "es el mejor para" (mejor usado como "es ideal para" o "es la mejor opci�n para").
