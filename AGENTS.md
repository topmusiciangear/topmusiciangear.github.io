...
- **Gear4Music SIN IVA**: los precios de Gear4Music en TEST_SHOP_BTN deben ser SIN IVA (precio ex-VAT). Las p�ginas de G4M UK muestran "Price Includes VAT @ 20%". Dividir entre 1.20 para obtener el precio ex-VAT. **EXCEPCI�N**: si el usuario ve el�62.00 desde otra ubicaci�n, usar ese precio.
